...
import ma.zs.zyn.service.impl.collaborator.packaging.PackagingCollaboratorServiceImpl;
import ma.zs.zyn.ws.facade.collaborator.packaging.PackagingRestCollaborator;
...
public class PackagingRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private PackagingCollaboratorServiceImpl service;
    @Mock
    private PackagingConverter converter;

    @InjectMocks
    private PackagingRestCollaborator controller;
