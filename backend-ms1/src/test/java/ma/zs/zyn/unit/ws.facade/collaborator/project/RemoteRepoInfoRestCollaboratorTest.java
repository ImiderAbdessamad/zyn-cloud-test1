...
import ma.zs.zyn.service.impl.collaborator.project.RemoteRepoInfoCollaboratorServiceImpl;
import ma.zs.zyn.ws.facade.collaborator.project.RemoteRepoInfoRestCollaborator;
...
public class RemoteRepoInfoRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private RemoteRepoInfoCollaboratorServiceImpl service;
    @Mock
    private RemoteRepoInfoConverter converter;

    @InjectMocks
    private RemoteRepoInfoRestCollaborator controller;
