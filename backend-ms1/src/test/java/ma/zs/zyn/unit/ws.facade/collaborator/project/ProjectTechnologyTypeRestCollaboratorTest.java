...
import ma.zs.zyn.service.impl.collaborator.project.ProjectTechnologyTypeCollaboratorServiceImpl;
import ma.zs.zyn.ws.facade.collaborator.project.ProjectTechnologyTypeRestCollaborator;
...
public class ProjectTechnologyTypeRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private ProjectTechnologyTypeCollaboratorServiceImpl service;
    @Mock
    private ProjectTechnologyTypeConverter converter;

    @InjectMocks
    private ProjectTechnologyTypeRestCollaborator controller;
