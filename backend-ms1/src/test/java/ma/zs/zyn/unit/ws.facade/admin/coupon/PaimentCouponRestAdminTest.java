...
import ma.zs.zyn.ws.facade.admin.coupon.PaimentCouponRestAdmin;
...
public class PaimentCouponRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private PaimentCouponAdminServiceImpl service;
    @Mock
    private PaimentCouponConverter converter;

    @InjectMocks
    private PaimentCouponRestAdmin controller;
