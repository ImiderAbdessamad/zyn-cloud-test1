...
import ma.zs.zyn.service.impl.influencer.coupon.InfluencerInfluencerServiceImpl;
import ma.zs.zyn.ws.facade.influencer.coupon.InfluencerRestInfluencer;
...
public class InfluencerRestInfluencerTest {

    private MockMvc mockMvc;

    @Mock
    private InfluencerInfluencerServiceImpl service;
    @Mock
    private InfluencerConverter converter;

    @InjectMocks
    private InfluencerRestInfluencer controller;
