...
import ma.zs.zyn.service.impl.agent.support.CustumorSupportConversationMessageAgentServiceImpl;
import ma.zs.zyn.ws.facade.agent.support.CustumorSupportConversationMessageRestAgent;
...
public class CustumorSupportConversationMessageRestAgentTest {

    private MockMvc mockMvc;

    @Mock
    private CustumorSupportConversationMessageAgentServiceImpl service;
    @Mock
    private CustumorSupportConversationMessageConverter converter;

    @InjectMocks
    private CustumorSupportConversationMessageRestAgent controller;
