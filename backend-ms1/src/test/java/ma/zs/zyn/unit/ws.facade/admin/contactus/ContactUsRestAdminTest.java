...
import ma.zs.zyn.ws.facade.admin.contactus.ContactUsRestAdmin;
...
public class ContactUsRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private ContactUsAdminServiceImpl service;
    @Mock
    private ContactUsConverter converter;

    @InjectMocks
    private ContactUsRestAdmin controller;
