...
import ma.zs.zyn.service.impl.influencer.coupon.CouponInfluencerServiceImpl;
import ma.zs.zyn.ws.facade.influencer.coupon.CouponRestInfluencer;
...
public class CouponRestInfluencerTest {

    private MockMvc mockMvc;

    @Mock
    private CouponInfluencerServiceImpl service;
    @Mock
    private CouponConverter converter;

    @InjectMocks
    private CouponRestInfluencer controller;
    ...
    public void itShouldSaveCouponTest() throws Exception {
        ...
        assertEquals(savedDto.getDiscountCollaborator(), responseBody.getDiscountCollaborator());
        assertEquals(savedDto.getPercentInflucencer(), responseBody.getPercentInflucencer());
        assertEquals(savedDto.getNombreInscriptionMax(), responseBody.getNombreInscriptionMax());
        assertEquals(savedDto.getNombreCollaboratorInscrit(), responseBody.getNombreCollaboratorInscrit());
    }
