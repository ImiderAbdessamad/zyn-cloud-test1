...
import ma.zs.zyn.service.impl.agent.support.CustumorSupportConversationAgentServiceImpl;
import ma.zs.zyn.ws.facade.agent.support.CustumorSupportConversationRestAgent;
...
public class CustumorSupportConversationRestAgentTest {

    private MockMvc mockMvc;

    @Mock
    private CustumorSupportConversationAgentServiceImpl service;
    @Mock
    private CustumorSupportConversationConverter converter;

    @InjectMocks
    private CustumorSupportConversationRestAgent controller;
