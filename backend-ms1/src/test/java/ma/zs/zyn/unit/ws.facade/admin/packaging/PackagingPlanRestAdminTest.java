...
import ma.zs.zyn.ws.facade.admin.packaging.PackagingPlanRestAdmin;
...
public class PackagingPlanRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private PackagingPlanAdminServiceImpl service;
    @Mock
    private PackagingPlanConverter converter;

    @InjectMocks
    private PackagingPlanRestAdmin controller;
