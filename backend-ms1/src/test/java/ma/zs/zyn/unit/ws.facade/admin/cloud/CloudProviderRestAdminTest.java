...
import ma.zs.zyn.ws.facade.admin.cloud.CloudProviderRestAdmin;
...
public class CloudProviderRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private CloudProviderAdminServiceImpl service;
    @Mock
    private CloudProviderConverter converter;

    @InjectMocks
    private CloudProviderRestAdmin controller;
