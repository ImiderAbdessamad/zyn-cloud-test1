...
import ma.zs.zyn.service.impl.collaborator.forum.ForumCommentCollaboratorServiceImpl;
import ma.zs.zyn.ws.facade.collaborator.forum.ForumCommentRestCollaborator;
...
public class ForumCommentRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private ForumCommentCollaboratorServiceImpl service;
    @Mock
    private ForumCommentConverter converter;

    @InjectMocks
    private ForumCommentRestCollaborator controller;
