...
import ma.zs.zyn.service.impl.collaborator.collaborator.CountryCollaboratorServiceImpl;
import ma.zs.zyn.ws.facade.collaborator.collaborator.CountryRestCollaborator;
...
public class CountryRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private CountryCollaboratorServiceImpl service;
    @Mock
    private CountryConverter converter;

    @InjectMocks
    private CountryRestCollaborator controller;
