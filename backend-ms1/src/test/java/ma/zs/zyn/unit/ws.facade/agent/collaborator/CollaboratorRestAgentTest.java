package ma.zs.zyn.unit.ws.facade.agent.collaborator;

import ma.zs.zyn.bean.core.collaborator.Collaborator;
import ma.zs.zyn.service.impl.agent.collaborator.CollaboratorAgentServiceImpl;
import ma.zs.zyn.ws.facade.agent.collaborator.CollaboratorRestAgent;
...
public class CollaboratorRestAgentTest {

    private MockMvc mockMvc;

    @Mock
    private CollaboratorAgentServiceImpl service;
    @Mock
    private CollaboratorConverter converter;

    @InjectMocks
    private CollaboratorRestAgent controller;
