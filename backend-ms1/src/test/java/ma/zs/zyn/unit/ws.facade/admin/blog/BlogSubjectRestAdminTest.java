...
import ma.zs.zyn.ws.facade.admin.blog.BlogSubjectRestAdmin;
...
public class BlogSubjectRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private BlogSubjectAdminServiceImpl service;
    @Mock
    private BlogSubjectConverter converter;

    @InjectMocks
    private BlogSubjectRestAdmin controller;
