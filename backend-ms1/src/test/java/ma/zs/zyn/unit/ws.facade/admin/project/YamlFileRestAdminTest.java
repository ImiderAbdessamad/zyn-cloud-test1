...
import ma.zs.zyn.ws.facade.admin.project.YamlFileRestAdmin;
...
public class YamlFileRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private YamlFileAdminServiceImpl service;
    @Mock
    private YamlFileConverter converter;

    @InjectMocks
    private YamlFileRestAdmin controller;
