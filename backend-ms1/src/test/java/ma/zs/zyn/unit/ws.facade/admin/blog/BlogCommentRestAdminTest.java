...
import ma.zs.zyn.ws.facade.admin.blog.BlogCommentRestAdmin;
...
public class BlogCommentRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private BlogCommentAdminServiceImpl service;
    @Mock
    private BlogCommentConverter converter;

    @InjectMocks
    private BlogCommentRestAdmin controller;
