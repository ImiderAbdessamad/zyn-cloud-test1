...
import ma.zs.zyn.ws.facade.admin.support.AgentRestAdmin;
...
public class AgentRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private AgentAdminServiceImpl service;
    @Mock
    private AgentConverter converter;

    @InjectMocks
    private AgentRestAdmin controller;
