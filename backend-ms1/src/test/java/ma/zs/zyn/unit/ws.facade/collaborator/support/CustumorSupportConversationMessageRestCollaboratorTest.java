package ma.zs.zyn.unit.ws.facade.collaborator.support;

import ma.zs.zyn.bean.core.support.CustumorSupportConversationMessage;
import ma.zs.zyn.service.impl.collaborator.support.CustumorSupportConversationMessageCollaboratorServiceImpl;
import ma.zs.zyn.ws.facade.collaborator.support.CustumorSupportConversationMessageRestCollaborator;
...
public class CustumorSupportConversationMessageRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private CustumorSupportConversationMessageCollaboratorServiceImpl service;
    @Mock
    private CustumorSupportConversationMessageConverter converter;

    @InjectMocks
    private CustumorSupportConversationMessageRestCollaborator controller;
