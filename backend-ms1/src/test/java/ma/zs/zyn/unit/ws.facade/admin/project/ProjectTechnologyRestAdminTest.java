...
import ma.zs.zyn.ws.facade.admin.project.ProjectTechnologyRestAdmin;
...
public class ProjectTechnologyRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private ProjectTechnologyAdminServiceImpl service;
    @Mock
    private ProjectTechnologyConverter converter;

    @InjectMocks
    private ProjectTechnologyRestAdmin controller;
