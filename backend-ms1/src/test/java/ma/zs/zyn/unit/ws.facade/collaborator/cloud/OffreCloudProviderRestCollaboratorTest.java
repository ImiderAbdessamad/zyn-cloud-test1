...
import ma.zs.zyn.service.impl.collaborator.cloud.OffreCloudProviderCollaboratorServiceImpl;
import ma.zs.zyn.ws.facade.collaborator.cloud.OffreCloudProviderRestCollaborator;
...
public class OffreCloudProviderRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private OffreCloudProviderCollaboratorServiceImpl service;
    @Mock
    private OffreCloudProviderConverter converter;

    @InjectMocks
    private OffreCloudProviderRestCollaborator controller;
