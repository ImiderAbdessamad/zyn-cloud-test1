...
import ma.zs.zyn.ws.facade.admin.project.ProjectDetailRestAdmin;
...
public class ProjectDetailRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private ProjectDetailAdminServiceImpl service;
    @Mock
    private ProjectDetailConverter converter;

    @InjectMocks
    private ProjectDetailRestAdmin controller;
