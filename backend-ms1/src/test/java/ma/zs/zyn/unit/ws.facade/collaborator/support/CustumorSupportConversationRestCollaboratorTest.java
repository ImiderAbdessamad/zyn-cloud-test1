...
import ma.zs.zyn.service.impl.collaborator.support.CustumorSupportConversationCollaboratorServiceImpl;
import ma.zs.zyn.ws.facade.collaborator.support.CustumorSupportConversationRestCollaborator;
...
public class CustumorSupportConversationRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private CustumorSupportConversationCollaboratorServiceImpl service;
    @Mock
    private CustumorSupportConversationConverter converter;

    @InjectMocks
    private CustumorSupportConversationRestCollaborator controller;
