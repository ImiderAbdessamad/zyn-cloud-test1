...
import ma.zs.zyn.ws.facade.admin.forum.ForumRestAdmin;
...
public class ForumRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private ForumAdminServiceImpl service;
    @Mock
    private ForumConverter converter;

    @InjectMocks
    private ForumRestAdmin controller;
