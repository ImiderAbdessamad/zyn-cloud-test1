...
public class BlogCommentRestCollaborator {
   ...
   public BlogCommentRestCollaborator(BlogCommentCollaboratorService service, BlogCommentConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final BlogCommentCollaboratorService service;
