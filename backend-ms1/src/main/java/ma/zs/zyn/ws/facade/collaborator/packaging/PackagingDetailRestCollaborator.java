...
@RestController
@RequestMapping("/api/collaborator/packagingDetail/")
public class PackagingDetailRestCollaborator {
   ...
   public PackagingDetailRestCollaborator(PackagingDetailCollaboratorService service, PackagingDetailConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final PackagingDetailCollaboratorService service;
