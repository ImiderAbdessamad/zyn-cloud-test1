...
@RestController
@RequestMapping("/api/open/blog/")
public class BlogRestOpen {
   ...
   public BlogRestOpen(BlogOpenService service, BlogConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final BlogOpenService service;
