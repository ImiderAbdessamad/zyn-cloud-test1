...
public class ProjectTechnologyRestCollaborator {
   ...
   public ProjectTechnologyRestCollaborator(ProjectTechnologyCollaboratorService service, ProjectTechnologyConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final ProjectTechnologyCollaboratorService service;
