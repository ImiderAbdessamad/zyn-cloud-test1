...
@RestController
@RequestMapping("/api/admin/packagingDetailGroup/")
public class PackagingDetailGroupRestAdmin {
   ...
   public PackagingDetailGroupRestAdmin(PackagingDetailGroupAdminService service, PackagingDetailGroupConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final PackagingDetailGroupAdminService service;
