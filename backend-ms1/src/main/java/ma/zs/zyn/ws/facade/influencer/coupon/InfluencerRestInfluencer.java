package  ma.zs.zyn.ws.facade.influencer.coupon;
...
public class InfluencerRestInfluencer {
   ...
   public InfluencerRestInfluencer(InfluencerInfluencerService service, InfluencerConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final InfluencerInfluencerService service;
