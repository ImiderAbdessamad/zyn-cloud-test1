package  ma.zs.zyn.ws.facade.open.blog;
...
@RestController
@RequestMapping("/api/open/blogComment/")
public class BlogCommentRestOpen {
   ...
   public BlogCommentRestOpen(BlogCommentOpenService service, BlogCommentConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final BlogCommentOpenService service;
