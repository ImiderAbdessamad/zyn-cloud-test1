...
@RestController
@RequestMapping("/api/collaborator/packagingPlan/")
public class PackagingPlanRestCollaborator {
   ...
   public PackagingPlanRestCollaborator(PackagingPlanCollaboratorService service, PackagingPlanConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final PackagingPlanCollaboratorService service;
