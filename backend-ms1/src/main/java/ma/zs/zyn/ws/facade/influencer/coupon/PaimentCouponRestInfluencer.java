...
public class PaimentCouponRestInfluencer {
   ...
   public PaimentCouponRestInfluencer(PaimentCouponInfluencerService service, PaimentCouponConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final PaimentCouponInfluencerService service;
