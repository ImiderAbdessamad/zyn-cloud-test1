...
@RestController
@RequestMapping("/api/open/packagingPlan/")
public class PackagingPlanRestOpen {
   ...
   public PackagingPlanRestOpen(PackagingPlanOpenService service, PackagingPlanConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final PackagingPlanOpenService service;
