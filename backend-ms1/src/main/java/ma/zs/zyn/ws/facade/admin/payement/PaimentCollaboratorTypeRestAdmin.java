...
public class PaimentCollaboratorTypeRestAdmin {
   ...
   public PaimentCollaboratorTypeRestAdmin(PaimentCollaboratorTypeAdminService service, PaimentCollaboratorTypeConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final PaimentCollaboratorTypeAdminService service;
