...
public class CloudProviderRestCollaborator {
   ...
   public CloudProviderRestCollaborator(CloudProviderCollaboratorService service, CloudProviderConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final CloudProviderCollaboratorService service;
