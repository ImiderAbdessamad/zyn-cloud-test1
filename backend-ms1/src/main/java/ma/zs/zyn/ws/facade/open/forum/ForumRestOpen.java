...
@RestController
@RequestMapping("/api/open/forum/")
public class ForumRestOpen {
   ...
   public ForumRestOpen(ForumOpenService service, ForumConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final ForumOpenService service;
