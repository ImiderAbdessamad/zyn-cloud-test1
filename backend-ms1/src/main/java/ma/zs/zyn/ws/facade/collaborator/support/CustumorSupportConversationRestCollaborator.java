...
public class CustumorSupportConversationRestCollaborator {
   ...
   public CustumorSupportConversationRestCollaborator(CustumorSupportConversationCollaboratorService service, CustumorSupportConversationConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final CustumorSupportConversationCollaboratorService service;
