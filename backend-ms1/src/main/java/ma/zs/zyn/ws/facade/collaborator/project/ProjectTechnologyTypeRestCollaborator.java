...
public class ProjectTechnologyTypeRestCollaborator {
   ...
   public ProjectTechnologyTypeRestCollaborator(ProjectTechnologyTypeCollaboratorService service, ProjectTechnologyTypeConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final ProjectTechnologyTypeCollaboratorService service;
