...
public class ProjectTechnologyProfileRestAdmin {
   ...
   public ProjectTechnologyProfileRestAdmin(ProjectTechnologyProfileAdminService service, ProjectTechnologyProfileConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final ProjectTechnologyProfileAdminService service;
