...
public class ForumCommentRestCollaborator {
   ...
   public ForumCommentRestCollaborator(ForumCommentCollaboratorService service, ForumCommentConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final ForumCommentCollaboratorService service;
