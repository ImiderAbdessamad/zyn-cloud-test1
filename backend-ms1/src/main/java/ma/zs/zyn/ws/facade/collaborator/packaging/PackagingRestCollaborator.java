...
public class PackagingRestCollaborator {
   ...
   public PackagingRestCollaborator(PackagingCollaboratorService service, PackagingConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final PackagingCollaboratorService service;
    private final PackagingConverter converter;
