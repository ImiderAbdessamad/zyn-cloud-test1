...
@RestController
@RequestMapping("/api/open/packagingDetailGroup/")
public class PackagingDetailGroupRestOpen {
   ...
   public PackagingDetailGroupRestOpen(PackagingDetailGroupOpenService service, PackagingDetailGroupConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final PackagingDetailGroupOpenService service;
