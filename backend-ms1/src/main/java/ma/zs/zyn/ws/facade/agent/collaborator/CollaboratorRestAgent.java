package  ma.zs.zyn.ws.facade.agent.collaborator;
...
@RestController
@RequestMapping("/api/agent/collaborator/")
public class CollaboratorRestAgent {
   ...
   public CollaboratorRestAgent(CollaboratorAgentService service, CollaboratorConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final CollaboratorAgentService service;
