...
public class ForumSubjectRestCollaborator {
   ...
   public ForumSubjectRestCollaborator(ForumSubjectCollaboratorService service, ForumSubjectConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final ForumSubjectCollaboratorService service;
