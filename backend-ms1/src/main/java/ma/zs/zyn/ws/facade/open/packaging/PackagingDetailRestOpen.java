...
import ma.zs.zyn.service.facade.open.packaging.PackagingDetailOpenService;
...
@RestController
@RequestMapping("/api/open/packagingDetail/")
public class PackagingDetailRestOpen {
   ...
   public PackagingDetailRestOpen(PackagingDetailOpenService service, PackagingDetailConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final PackagingDetailOpenService service;
