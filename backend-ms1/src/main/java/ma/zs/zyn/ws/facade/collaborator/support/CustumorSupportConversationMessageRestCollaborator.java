...
public class CustumorSupportConversationMessageRestCollaborator {
   ...
   public CustumorSupportConversationMessageRestCollaborator(CustumorSupportConversationMessageCollaboratorService service, CustumorSupportConversationMessageConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final CustumorSupportConversationMessageCollaboratorService service;
