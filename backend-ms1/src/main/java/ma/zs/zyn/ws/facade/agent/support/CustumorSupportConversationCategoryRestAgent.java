...
@RestController
@RequestMapping("/api/agent/custumorSupportConversationCategory/")
public class CustumorSupportConversationCategoryRestAgent {
   ...
   public CustumorSupportConversationCategoryRestAgent(CustumorSupportConversationCategoryAgentService service, CustumorSupportConversationCategoryConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final CustumorSupportConversationCategoryAgentService service;
