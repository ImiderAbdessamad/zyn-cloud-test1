...
public class ConversationRestCollaborator {
   ...
   public ConversationRestCollaborator(ConversationCollaboratorService service, ConversationConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final ConversationCollaboratorService service;
