...
public class CouponRestInfluencer {
   ...
   public CouponRestInfluencer(CouponInfluencerService service, CouponConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final CouponInfluencerService service;
    private final CouponConverter converter;
