package  ma.zs.zyn.ws.facade.open.contactus;
...
@RestController
@RequestMapping("/api/open/contactUs/")
public class ContactUsRestOpen {
   ...
   public ContactUsRestOpen(ContactUsOpenService service, ContactUsConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final ContactUsOpenService service;
