...
public class OffreCloudProviderRestCollaborator {
   ...
   public OffreCloudProviderRestCollaborator(OffreCloudProviderCollaboratorService service, OffreCloudProviderConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final OffreCloudProviderCollaboratorService service;
