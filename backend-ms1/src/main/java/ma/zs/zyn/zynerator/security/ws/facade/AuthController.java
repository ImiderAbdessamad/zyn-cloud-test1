...
public class AuthController {
    ...
    public ResponseEntity<Map<String, String>> registerOpen(@RequestBody UserDto userDto) {
        return register(userDto, AuthoritiesConstants.OPEN);
    }
    @PostMapping("register/agent")
    public ResponseEntity<Map<String, String>> registerAgent(@RequestBody UserDto userDto) {
        return register(userDto, AuthoritiesConstants.AGENT);
    }
