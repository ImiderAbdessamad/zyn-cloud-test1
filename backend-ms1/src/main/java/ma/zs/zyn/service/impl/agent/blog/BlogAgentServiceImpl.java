...
import ma.zs.zyn.service.facade.agent.blog.BlogAgentService;
...
import ma.zs.zyn.service.facade.agent.blog.BlogCommentAgentService ;
import ma.zs.zyn.bean.core.blog.BlogComment ;
import ma.zs.zyn.service.facade.agent.blog.BlogStateAgentService ;
...
public class BlogAgentServiceImpl implements BlogAgentService {
    ...
    @Autowired
    private BlogSubjectAgentService blogSubjectService ;
    @Autowired
    private BlogCommentAgentService blogCommentService ;
    @Autowired
    private BlogStateAgentService blogStateService ;

    public BlogAgentServiceImpl(BlogDao dao) {
        this.dao = dao;
    }
