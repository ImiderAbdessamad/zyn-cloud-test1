...
import java.util.List;
@Service
public class PackagingDetailOpenServiceImpl implements PackagingDetailOpenService {
    ...
    @Autowired
    private PackagingDetailGroupOpenService packagingDetailGroupService ;
    @Autowired
    private PackagingOpenService packagingService ;

    public PackagingDetailOpenServiceImpl(PackagingDetailDao dao) {
        this.dao = dao;
    }
