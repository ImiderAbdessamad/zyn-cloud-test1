...
import ma.zs.zyn.service.facade.agent.project.RemoteRepoInfoAgentService ;
import ma.zs.zyn.bean.core.project.RemoteRepoInfo ;
import ma.zs.zyn.service.facade.agent.project.ConversationAgentService ;
...
public class ProjectAgentServiceImpl implements ProjectAgentService {
    ...
    @Autowired
    private RemoteRepoInfoAgentService remoteRepoInfoService ;
    @Autowired
    private ConversationAgentService conversationService ;
    @Autowired
    private ProjectDetailAgentService projectDetailService ;

    public ProjectAgentServiceImpl(ProjectDao dao) {
        this.dao = dao;
    }
