...
import java.util.List;
@Service
public class CustumorSupportConversationStateOpenServiceImpl implements CustumorSupportConversationStateOpenService {
    ...
    public CustumorSupportConversationStateOpenServiceImpl(CustumorSupportConversationStateDao dao) {
        this.dao = dao;
    }
