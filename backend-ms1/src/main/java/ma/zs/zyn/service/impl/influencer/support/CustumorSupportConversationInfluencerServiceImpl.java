package ma.zs.zyn.service.impl.influencer.support;
...
import ma.zs.zyn.service.facade.influencer.support.CustumorSupportConversationInfluencerService;
...
import ma.zs.zyn.service.facade.influencer.support.AgentInfluencerService ;
import ma.zs.zyn.bean.core.support.Agent ;
import ma.zs.zyn.service.facade.influencer.support.CustumorSupportConversationCategoryInfluencerService ;
import ma.zs.zyn.bean.core.support.CustumorSupportConversationCategory ;
import ma.zs.zyn.service.facade.influencer.support.CustumorSupportConversationStateInfluencerService ;
import ma.zs.zyn.bean.core.support.CustumorSupportConversationState ;
import ma.zs.zyn.service.facade.influencer.support.CustumorSupportConversationMessageInfluencerService ;
import ma.zs.zyn.bean.core.support.CustumorSupportConversationMessage ;

import java.util.List;
@Service
public class CustumorSupportConversationInfluencerServiceImpl implements CustumorSupportConversationInfluencerService {
    ...
    @Autowired
    private AgentInfluencerService agentService ;
    @Autowired
    private CustumorSupportConversationCategoryInfluencerService custumorSupportConversationCategoryService ;
    @Autowired
    private CustumorSupportConversationStateInfluencerService custumorSupportConversationStateService ;
    @Autowired
    private CustumorSupportConversationMessageInfluencerService custumorSupportConversationMessageService ;

    public CustumorSupportConversationInfluencerServiceImpl(CustumorSupportConversationDao dao) {
        this.dao = dao;
    }
