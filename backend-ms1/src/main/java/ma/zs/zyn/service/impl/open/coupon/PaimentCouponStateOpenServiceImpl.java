...
import java.util.List;
@Service
public class PaimentCouponStateOpenServiceImpl implements PaimentCouponStateOpenService {
    ...
    public PaimentCouponStateOpenServiceImpl(PaimentCouponStateDao dao) {
        this.dao = dao;
    }
