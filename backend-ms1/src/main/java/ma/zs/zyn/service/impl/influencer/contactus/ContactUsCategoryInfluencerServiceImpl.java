...
import java.util.List;
@Service
public class ContactUsCategoryInfluencerServiceImpl implements ContactUsCategoryInfluencerService {
    ...
    public ContactUsCategoryInfluencerServiceImpl(ContactUsCategoryDao dao) {
        this.dao = dao;
    }
