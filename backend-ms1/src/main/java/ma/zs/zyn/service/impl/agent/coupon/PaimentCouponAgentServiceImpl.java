package ma.zs.zyn.service.impl.agent.coupon;
...
import ma.zs.zyn.service.facade.agent.coupon.PaimentCouponAgentService;
...
import ma.zs.zyn.service.facade.agent.coupon.PaimentCouponStateAgentService ;
import ma.zs.zyn.bean.core.coupon.PaimentCouponState ;

import java.util.List;
@Service
public class PaimentCouponAgentServiceImpl implements PaimentCouponAgentService {
    ...
    @Autowired
    private PaimentCouponStateAgentService paimentCouponStateService ;

    public PaimentCouponAgentServiceImpl(PaimentCouponDao dao) {
        this.dao = dao;
    }
