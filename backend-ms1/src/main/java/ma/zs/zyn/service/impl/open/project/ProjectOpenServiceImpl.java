...
public class ProjectOpenServiceImpl implements ProjectOpenService {
    ...
    @Autowired
    private RemoteRepoInfoOpenService remoteRepoInfoService ;
    @Autowired
    private ConversationOpenService conversationService ;
    @Autowired
    private ProjectDetailOpenService projectDetailService ;

    public ProjectOpenServiceImpl(ProjectDao dao) {
        this.dao = dao;
    }
