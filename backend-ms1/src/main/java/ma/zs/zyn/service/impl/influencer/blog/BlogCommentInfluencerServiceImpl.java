...
import java.util.List;
@Service
public class BlogCommentInfluencerServiceImpl implements BlogCommentInfluencerService {
    ...
    @Autowired
    private BlogInfluencerService blogService ;

    public BlogCommentInfluencerServiceImpl(BlogCommentDao dao) {
        this.dao = dao;
    }
