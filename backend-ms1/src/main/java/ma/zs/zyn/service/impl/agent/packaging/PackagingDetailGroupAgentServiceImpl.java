...
import java.util.List;
@Service
public class PackagingDetailGroupAgentServiceImpl implements PackagingDetailGroupAgentService {
    ...
    public PackagingDetailGroupAgentServiceImpl(PackagingDetailGroupDao dao) {
        this.dao = dao;
    }
