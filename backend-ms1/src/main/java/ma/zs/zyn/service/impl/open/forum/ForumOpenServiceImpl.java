...
import ma.zs.zyn.service.facade.open.forum.ForumOpenService;
...
import ma.zs.zyn.service.facade.open.forum.ForumStateOpenService ;
...
import java.util.List;
@Service
public class ForumOpenServiceImpl implements ForumOpenService {
    ...
    @Autowired
    private ForumSubjectOpenService forumSubjectService ;
    @Autowired
    private ForumStateOpenService forumStateService ;
    @Autowired
    private ForumCommentOpenService forumCommentService ;

    public ForumOpenServiceImpl(ForumDao dao) {
        this.dao = dao;
    }
