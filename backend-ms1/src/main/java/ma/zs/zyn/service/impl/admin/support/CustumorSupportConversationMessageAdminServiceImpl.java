...
import java.util.List;
@Service
public class CustumorSupportConversationMessageAdminServiceImpl implements CustumorSupportConversationMessageAdminService {
    ...
    @Autowired
    private CustumorSupportConversationAdminService custumorSupportConversationService ;

    public CustumorSupportConversationMessageAdminServiceImpl(CustumorSupportConversationMessageDao dao) {
        this.dao = dao;
    }
