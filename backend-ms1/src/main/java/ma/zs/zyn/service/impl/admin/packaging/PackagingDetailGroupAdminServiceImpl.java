...
import java.util.List;
@Service
public class PackagingDetailGroupAdminServiceImpl implements PackagingDetailGroupAdminService {
    ...
    public PackagingDetailGroupAdminServiceImpl(PackagingDetailGroupDao dao) {
        this.dao = dao;
    }
