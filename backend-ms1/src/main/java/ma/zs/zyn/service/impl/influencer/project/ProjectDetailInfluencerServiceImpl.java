...
import ma.zs.zyn.service.facade.influencer.project.ProjectDetailInfluencerService;
...
import ma.zs.zyn.service.facade.influencer.project.ProjectTechnologyInfluencerService ;
import ma.zs.zyn.bean.core.project.ProjectTechnology ;
import ma.zs.zyn.service.facade.influencer.project.ProjectTechnologyProfileInfluencerService ;
import ma.zs.zyn.bean.core.project.ProjectTechnologyProfile ;

import java.util.List;
@Service
public class ProjectDetailInfluencerServiceImpl implements ProjectDetailInfluencerService {
    ...
    @Autowired
    private ProjectInfluencerService projectService ;
    @Autowired
    private ProjectTechnologyInfluencerService projectTechnologyService ;
    @Autowired
    private ProjectTechnologyProfileInfluencerService projectTechnologyProfileService ;

    public ProjectDetailInfluencerServiceImpl(ProjectDetailDao dao) {
        this.dao = dao;
    }
