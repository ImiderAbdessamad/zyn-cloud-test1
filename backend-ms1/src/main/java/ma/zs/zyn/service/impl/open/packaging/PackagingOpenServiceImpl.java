...
import java.util.List;
@Service
public class PackagingOpenServiceImpl implements PackagingOpenService {
    ...
    @Autowired
    private PackagingDetailOpenService packagingDetailService ;

    public PackagingOpenServiceImpl(PackagingDao dao) {
        this.dao = dao;
    }
