...
import ma.zs.zyn.service.facade.influencer.forum.ForumSubjectInfluencerService ;
import ma.zs.zyn.bean.core.forum.ForumSubject ;
import ma.zs.zyn.service.facade.influencer.forum.ForumStateInfluencerService ;
...
import java.util.List;
@Service
public class ForumInfluencerServiceImpl implements ForumInfluencerService {
    ...
    @Autowired
    private ForumSubjectInfluencerService forumSubjectService ;
    @Autowired
    private ForumStateInfluencerService forumStateService ;
    @Autowired
    private ForumCommentInfluencerService forumCommentService ;

    public ForumInfluencerServiceImpl(ForumDao dao) {
        this.dao = dao;
    }
