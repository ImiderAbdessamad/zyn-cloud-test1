...
import java.util.List;
@Service
public class ContactUsCategoryAgentServiceImpl implements ContactUsCategoryAgentService {
    ...
    public ContactUsCategoryAgentServiceImpl(ContactUsCategoryDao dao) {
        this.dao = dao;
    }
