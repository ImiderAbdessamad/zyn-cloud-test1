...
import java.util.List;
@Service
public class CustumorSupportConversationCategoryInfluencerServiceImpl implements CustumorSupportConversationCategoryInfluencerService {
    ...
    public CustumorSupportConversationCategoryInfluencerServiceImpl(CustumorSupportConversationCategoryDao dao) {
        this.dao = dao;
    }
