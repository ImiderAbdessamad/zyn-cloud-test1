...
import java.util.List;
@Service
public class PaimentCouponStateAgentServiceImpl implements PaimentCouponStateAgentService {
    ...
    public PaimentCouponStateAgentServiceImpl(PaimentCouponStateDao dao) {
        this.dao = dao;
    }
