...
import ma.zs.zyn.service.facade.agent.project.ProjectTechnologyTypeAgentService ;
import ma.zs.zyn.bean.core.project.ProjectTechnologyType ;

import java.util.List;
@Service
public class ProjectTechnologyAgentServiceImpl implements ProjectTechnologyAgentService {
    ...
    @Autowired
    private ProjectTechnologyTypeAgentService projectTechnologyTypeService ;

    public ProjectTechnologyAgentServiceImpl(ProjectTechnologyDao dao) {
        this.dao = dao;
    }
