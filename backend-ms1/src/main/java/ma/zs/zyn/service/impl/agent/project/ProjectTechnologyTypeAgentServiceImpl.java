...
import java.util.List;
@Service
public class ProjectTechnologyTypeAgentServiceImpl implements ProjectTechnologyTypeAgentService {
    ...
    public ProjectTechnologyTypeAgentServiceImpl(ProjectTechnologyTypeDao dao) {
        this.dao = dao;
    }
