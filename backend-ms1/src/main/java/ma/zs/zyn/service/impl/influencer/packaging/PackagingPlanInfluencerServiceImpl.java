...
import java.util.List;
@Service
public class PackagingPlanInfluencerServiceImpl implements PackagingPlanInfluencerService {
    ...
    public PackagingPlanInfluencerServiceImpl(PackagingPlanDao dao) {
        this.dao = dao;
    }
