...
import java.util.List;
@Service
public class BlogCommentOpenServiceImpl implements BlogCommentOpenService {
    ...
    @Autowired
    private BlogOpenService blogService ;

    public BlogCommentOpenServiceImpl(BlogCommentDao dao) {
        this.dao = dao;
    }
