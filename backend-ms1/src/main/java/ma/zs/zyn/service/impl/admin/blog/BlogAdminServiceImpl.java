...
public class BlogAdminServiceImpl implements BlogAdminService {
    ...
    public void findOrSaveAssociatedObject(Blog t){
        if( t != null) {
            ...
            t.setBlogState(blogStateService.findOrSave(t.getBlogState()));
        }
    }
    ...
    @Autowired
    private BlogSubjectAdminService blogSubjectService ;
    @Autowired
    private BlogCommentAdminService blogCommentService ;
    @Autowired
    private BlogStateAdminService blogStateService ;
