...
import java.util.List;
@Service
public class CustumorSupportConversationMessageInfluencerServiceImpl implements CustumorSupportConversationMessageInfluencerService {
    ...
    @Autowired
    private CustumorSupportConversationInfluencerService custumorSupportConversationService ;

    public CustumorSupportConversationMessageInfluencerServiceImpl(CustumorSupportConversationMessageDao dao) {
        this.dao = dao;
    }
