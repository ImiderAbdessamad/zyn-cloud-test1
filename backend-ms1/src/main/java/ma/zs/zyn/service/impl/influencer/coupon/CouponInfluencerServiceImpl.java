...
import ma.zs.zyn.service.facade.influencer.coupon.InfluencerInfluencerService ;
...
import java.util.List;
@Service
public class CouponInfluencerServiceImpl implements CouponInfluencerService {
    ...
    @Autowired
    private InfluencerInfluencerService influencerService ;
    @Autowired
    private CouponStateInfluencerService couponStateService ;

    public CouponInfluencerServiceImpl(CouponDao dao) {
        this.dao = dao;
    }
