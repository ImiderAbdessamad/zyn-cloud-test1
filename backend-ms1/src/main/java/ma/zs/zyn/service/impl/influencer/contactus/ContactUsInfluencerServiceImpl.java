...
import ma.zs.zyn.service.facade.influencer.contactus.ContactUsInfluencerService;
...
import ma.zs.zyn.service.facade.influencer.contactus.ContactUsCategoryInfluencerService ;
...
import java.util.List;
@Service
public class ContactUsInfluencerServiceImpl implements ContactUsInfluencerService {
    ...
    @Autowired
    private ContactUsCategoryInfluencerService contactUsCategoryService ;
    @Autowired
    private ContactUsStateInfluencerService contactUsStateService ;

    public ContactUsInfluencerServiceImpl(ContactUsDao dao) {
        this.dao = dao;
    }
