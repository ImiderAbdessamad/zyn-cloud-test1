package ma.zs.zyn.service.impl.open.cloud;
...
import ma.zs.zyn.service.facade.open.cloud.CloudProviderOpenService ;
import ma.zs.zyn.bean.core.cloud.CloudProvider ;

import java.util.List;
@Service
public class OffreCloudProviderOpenServiceImpl implements OffreCloudProviderOpenService {
    ...
    @Autowired
    private CloudProviderOpenService cloudProviderService ;

    public OffreCloudProviderOpenServiceImpl(OffreCloudProviderDao dao) {
        this.dao = dao;
    }
