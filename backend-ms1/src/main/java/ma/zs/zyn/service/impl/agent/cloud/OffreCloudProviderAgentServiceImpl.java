package ma.zs.zyn.service.impl.agent.cloud;
...
import ma.zs.zyn.service.facade.agent.cloud.CloudProviderAgentService ;
import ma.zs.zyn.bean.core.cloud.CloudProvider ;

import java.util.List;
@Service
public class OffreCloudProviderAgentServiceImpl implements OffreCloudProviderAgentService {
    ...
    @Autowired
    private CloudProviderAgentService cloudProviderService ;

    public OffreCloudProviderAgentServiceImpl(OffreCloudProviderDao dao) {
        this.dao = dao;
    }
