...
import ma.zs.zyn.service.facade.open.project.ProjectTechnologyTypeOpenService ;
import ma.zs.zyn.bean.core.project.ProjectTechnologyType ;

import java.util.List;
@Service
public class ProjectTechnologyOpenServiceImpl implements ProjectTechnologyOpenService {
    ...
    @Autowired
    private ProjectTechnologyTypeOpenService projectTechnologyTypeService ;

    public ProjectTechnologyOpenServiceImpl(ProjectTechnologyDao dao) {
        this.dao = dao;
    }
