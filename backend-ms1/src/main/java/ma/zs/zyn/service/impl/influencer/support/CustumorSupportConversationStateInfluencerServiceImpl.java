...
import java.util.List;
@Service
public class CustumorSupportConversationStateInfluencerServiceImpl implements CustumorSupportConversationStateInfluencerService {
    ...
    public CustumorSupportConversationStateInfluencerServiceImpl(CustumorSupportConversationStateDao dao) {
        this.dao = dao;
    }
