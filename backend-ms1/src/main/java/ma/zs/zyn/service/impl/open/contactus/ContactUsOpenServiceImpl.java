package ma.zs.zyn.service.impl.open.contactus;
...
import ma.zs.zyn.service.facade.open.contactus.ContactUsOpenService;
...
import ma.zs.zyn.service.facade.open.contactus.ContactUsCategoryOpenService ;
import ma.zs.zyn.bean.core.contactus.ContactUsCategory ;
import ma.zs.zyn.service.facade.open.contactus.ContactUsStateOpenService ;
import ma.zs.zyn.bean.core.contactus.ContactUsState ;

import java.util.List;
@Service
public class ContactUsOpenServiceImpl implements ContactUsOpenService {
    ...
    @Autowired
    private ContactUsCategoryOpenService contactUsCategoryService ;
    @Autowired
    private ContactUsStateOpenService contactUsStateService ;

    public ContactUsOpenServiceImpl(ContactUsDao dao) {
        this.dao = dao;
    }
