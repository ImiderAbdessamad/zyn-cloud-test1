...
import java.util.List;
@Service
public class PaimentCollaboratorTypeInfluencerServiceImpl implements PaimentCollaboratorTypeInfluencerService {
    ...
    public PaimentCollaboratorTypeInfluencerServiceImpl(PaimentCollaboratorTypeDao dao) {
        this.dao = dao;
    }
