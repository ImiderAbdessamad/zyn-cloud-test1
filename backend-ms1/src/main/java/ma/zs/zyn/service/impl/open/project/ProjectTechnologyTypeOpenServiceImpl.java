...
import java.util.List;
@Service
public class ProjectTechnologyTypeOpenServiceImpl implements ProjectTechnologyTypeOpenService {
    ...
    public ProjectTechnologyTypeOpenServiceImpl(ProjectTechnologyTypeDao dao) {
        this.dao = dao;
    }
