...
import java.util.List;
@Service
public class PackagingInfluencerServiceImpl implements PackagingInfluencerService {
    ...
    @Autowired
    private PackagingDetailInfluencerService packagingDetailService ;

    public PackagingInfluencerServiceImpl(PackagingDao dao) {
        this.dao = dao;
    }
