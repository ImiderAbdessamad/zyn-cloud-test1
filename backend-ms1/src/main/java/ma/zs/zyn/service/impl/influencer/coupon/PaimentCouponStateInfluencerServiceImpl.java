...
import java.util.List;
@Service
public class PaimentCouponStateInfluencerServiceImpl implements PaimentCouponStateInfluencerService {
    ...
    public PaimentCouponStateInfluencerServiceImpl(PaimentCouponStateDao dao) {
        this.dao = dao;
    }
