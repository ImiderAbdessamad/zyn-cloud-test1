...
import java.util.List;
@Service
public class CustumorSupportConversationStateAdminServiceImpl implements CustumorSupportConversationStateAdminService {
    ...
    public CustumorSupportConversationStateAdminServiceImpl(CustumorSupportConversationStateDao dao) {
        this.dao = dao;
    }
