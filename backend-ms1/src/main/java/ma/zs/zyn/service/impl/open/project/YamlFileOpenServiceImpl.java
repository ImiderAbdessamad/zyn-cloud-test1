...
import ma.zs.zyn.service.facade.open.project.YamlFileOpenService;
...
import java.util.List;
@Service
public class YamlFileOpenServiceImpl implements YamlFileOpenService {
    ...
    public YamlFileOpenServiceImpl(YamlFileDao dao) {
        this.dao = dao;
    }
