...
import java.util.List;
@Service
public class PaimentCollaboratorTypeOpenServiceImpl implements PaimentCollaboratorTypeOpenService {
    ...
    public PaimentCollaboratorTypeOpenServiceImpl(PaimentCollaboratorTypeDao dao) {
        this.dao = dao;
    }
