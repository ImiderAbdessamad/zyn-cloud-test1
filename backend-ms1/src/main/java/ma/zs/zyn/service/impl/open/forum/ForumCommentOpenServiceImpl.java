...
import java.util.List;
@Service
public class ForumCommentOpenServiceImpl implements ForumCommentOpenService {
    ...
    @Autowired
    private ForumOpenService forumService ;

    public ForumCommentOpenServiceImpl(ForumCommentDao dao) {
        this.dao = dao;
    }
