...
import java.util.List;
@Service
public class PackagingDetailCollaboratorServiceImpl implements PackagingDetailCollaboratorService {
    ...
    @Autowired
    private PackagingDetailGroupCollaboratorService packagingDetailGroupService ;
    @Autowired
    private PackagingCollaboratorService packagingService ;

    public PackagingDetailCollaboratorServiceImpl(PackagingDetailDao dao) {
        this.dao = dao;
    }
