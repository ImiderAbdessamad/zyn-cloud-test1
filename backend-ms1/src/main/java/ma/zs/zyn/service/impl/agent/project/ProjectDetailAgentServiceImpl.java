package ma.zs.zyn.service.impl.agent.project;
...
import ma.zs.zyn.service.facade.agent.project.ProjectDetailAgentService;
...
import ma.zs.zyn.service.facade.agent.project.ProjectAgentService ;
import ma.zs.zyn.bean.core.project.Project ;
import ma.zs.zyn.service.facade.agent.project.ProjectTechnologyAgentService ;
import ma.zs.zyn.bean.core.project.ProjectTechnology ;
import ma.zs.zyn.service.facade.agent.project.ProjectTechnologyProfileAgentService ;
import ma.zs.zyn.bean.core.project.ProjectTechnologyProfile ;

import java.util.List;
@Service
public class ProjectDetailAgentServiceImpl implements ProjectDetailAgentService {
    ...
    @Autowired
    private ProjectAgentService projectService ;
    @Autowired
    private ProjectTechnologyAgentService projectTechnologyService ;
    @Autowired
    private ProjectTechnologyProfileAgentService projectTechnologyProfileService ;

    public ProjectDetailAgentServiceImpl(ProjectDetailDao dao) {
        this.dao = dao;
    }
