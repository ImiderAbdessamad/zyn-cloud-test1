...
import java.util.List;
@Service
public class RemoteRepoTypeInfluencerServiceImpl implements RemoteRepoTypeInfluencerService {
    ...
    public RemoteRepoTypeInfluencerServiceImpl(RemoteRepoTypeDao dao) {
        this.dao = dao;
    }
