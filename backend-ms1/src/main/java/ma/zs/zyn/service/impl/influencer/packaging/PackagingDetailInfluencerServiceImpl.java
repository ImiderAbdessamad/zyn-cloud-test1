package ma.zs.zyn.service.impl.influencer.packaging;
...
import ma.zs.zyn.service.facade.influencer.packaging.PackagingDetailInfluencerService;
...
import ma.zs.zyn.service.facade.influencer.packaging.PackagingDetailGroupInfluencerService ;
...
import java.util.List;
@Service
public class PackagingDetailInfluencerServiceImpl implements PackagingDetailInfluencerService {
    ...
    @Autowired
    private PackagingDetailGroupInfluencerService packagingDetailGroupService ;
    @Autowired
    private PackagingInfluencerService packagingService ;

    public PackagingDetailInfluencerServiceImpl(PackagingDetailDao dao) {
        this.dao = dao;
    }
