...
import ma.zs.zyn.service.facade.influencer.project.RemoteRepoInfoInfluencerService ;
import ma.zs.zyn.bean.core.project.RemoteRepoInfo ;
import ma.zs.zyn.service.facade.influencer.project.ConversationInfluencerService ;
...
import java.util.List;
@Service
public class ProjectInfluencerServiceImpl implements ProjectInfluencerService {
    ...
    @Autowired
    private RemoteRepoInfoInfluencerService remoteRepoInfoService ;
    @Autowired
    private ConversationInfluencerService conversationService ;
    @Autowired
    private ProjectDetailInfluencerService projectDetailService ;

    public ProjectInfluencerServiceImpl(ProjectDao dao) {
        this.dao = dao;
    }
