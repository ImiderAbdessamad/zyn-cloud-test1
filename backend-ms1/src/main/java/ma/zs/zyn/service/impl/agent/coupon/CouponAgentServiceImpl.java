...
import ma.zs.zyn.service.facade.agent.coupon.InfluencerAgentService ;
import ma.zs.zyn.bean.core.coupon.Influencer ;
import ma.zs.zyn.service.facade.agent.coupon.CouponStateAgentService ;
import ma.zs.zyn.bean.core.coupon.CouponState ;

import java.util.List;
@Service
public class CouponAgentServiceImpl implements CouponAgentService {
    ...
    @Autowired
    private InfluencerAgentService influencerService ;
    @Autowired
    private CouponStateAgentService couponStateService ;

    public CouponAgentServiceImpl(CouponDao dao) {
        this.dao = dao;
    }
