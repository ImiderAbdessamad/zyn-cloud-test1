...
import java.util.List;
@Service
public class ProjectTechnologyProfileAgentServiceImpl implements ProjectTechnologyProfileAgentService {
    ...
    public ProjectTechnologyProfileAgentServiceImpl(ProjectTechnologyProfileDao dao) {
        this.dao = dao;
    }
