...
import ma.zs.zyn.service.facade.open.coupon.PaimentCouponOpenService;
...
import ma.zs.zyn.service.facade.open.coupon.PaimentCouponStateOpenService ;
import ma.zs.zyn.bean.core.coupon.PaimentCouponState ;

import java.util.List;
@Service
public class PaimentCouponOpenServiceImpl implements PaimentCouponOpenService {
    ...
    @Autowired
    private PaimentCouponStateOpenService paimentCouponStateService ;

    public PaimentCouponOpenServiceImpl(PaimentCouponDao dao) {
        this.dao = dao;
    }
