...
import ma.zs.zyn.service.facade.agent.project.RemoteRepoTypeAgentService ;
import ma.zs.zyn.bean.core.project.RemoteRepoType ;

import java.util.List;
@Service
public class RemoteRepoInfoAgentServiceImpl implements RemoteRepoInfoAgentService {
    ...
    @Autowired
    private RemoteRepoTypeAgentService remoteRepoTypeService ;

    public RemoteRepoInfoAgentServiceImpl(RemoteRepoInfoDao dao) {
        this.dao = dao;
    }
