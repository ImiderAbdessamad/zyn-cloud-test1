...
import java.util.List;
@Service
public class CustumorSupportConversationCategoryAgentServiceImpl implements CustumorSupportConversationCategoryAgentService {
    ...
    public CustumorSupportConversationCategoryAgentServiceImpl(CustumorSupportConversationCategoryDao dao) {
        this.dao = dao;
    }
