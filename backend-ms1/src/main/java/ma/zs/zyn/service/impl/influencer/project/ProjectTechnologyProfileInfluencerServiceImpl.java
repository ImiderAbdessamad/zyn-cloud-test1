...
import java.util.List;
@Service
public class ProjectTechnologyProfileInfluencerServiceImpl implements ProjectTechnologyProfileInfluencerService {
    ...
    public ProjectTechnologyProfileInfluencerServiceImpl(ProjectTechnologyProfileDao dao) {
        this.dao = dao;
    }
