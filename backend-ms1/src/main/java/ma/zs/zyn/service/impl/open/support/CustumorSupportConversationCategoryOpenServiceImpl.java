...
import java.util.List;
@Service
public class CustumorSupportConversationCategoryOpenServiceImpl implements CustumorSupportConversationCategoryOpenService {
    ...
    public CustumorSupportConversationCategoryOpenServiceImpl(CustumorSupportConversationCategoryDao dao) {
        this.dao = dao;
    }
