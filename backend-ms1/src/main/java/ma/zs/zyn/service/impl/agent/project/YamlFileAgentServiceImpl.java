...
import ma.zs.zyn.service.facade.agent.project.YamlFileAgentService;
...
import java.util.List;
@Service
public class YamlFileAgentServiceImpl implements YamlFileAgentService {
    ...
    public YamlFileAgentServiceImpl(YamlFileDao dao) {
        this.dao = dao;
    }
