...
import java.util.List;
@Service
public class PackagingDetailGroupInfluencerServiceImpl implements PackagingDetailGroupInfluencerService {
    ...
    public PackagingDetailGroupInfluencerServiceImpl(PackagingDetailGroupDao dao) {
        this.dao = dao;
    }
