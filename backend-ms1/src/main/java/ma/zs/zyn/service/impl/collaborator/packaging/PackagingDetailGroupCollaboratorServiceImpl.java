...
import java.util.List;
@Service
public class PackagingDetailGroupCollaboratorServiceImpl implements PackagingDetailGroupCollaboratorService {
    ...
    public PackagingDetailGroupCollaboratorServiceImpl(PackagingDetailGroupDao dao) {
        this.dao = dao;
    }
