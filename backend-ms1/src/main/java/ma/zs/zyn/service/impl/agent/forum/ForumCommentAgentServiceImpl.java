...
import java.util.List;
@Service
public class ForumCommentAgentServiceImpl implements ForumCommentAgentService {
    ...
    @Autowired
    private ForumAgentService forumService ;

    public ForumCommentAgentServiceImpl(ForumCommentDao dao) {
        this.dao = dao;
    }
