...
import ma.zs.zyn.service.facade.open.project.ProjectDetailOpenService;
...
import ma.zs.zyn.service.facade.open.project.ProjectTechnologyOpenService ;
...
import java.util.List;
@Service
public class ProjectDetailOpenServiceImpl implements ProjectDetailOpenService {
    ...
    @Autowired
    private ProjectTechnologyOpenService projectTechnologyService ;
    @Autowired
    private ProjectTechnologyProfileOpenService projectTechnologyProfileService ;

    public ProjectDetailOpenServiceImpl(ProjectDetailDao dao) {
        this.dao = dao;
    }
