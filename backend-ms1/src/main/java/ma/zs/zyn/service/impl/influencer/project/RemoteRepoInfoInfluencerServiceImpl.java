...
import ma.zs.zyn.service.facade.influencer.project.RemoteRepoTypeInfluencerService ;
import ma.zs.zyn.bean.core.project.RemoteRepoType ;

import java.util.List;
@Service
public class RemoteRepoInfoInfluencerServiceImpl implements RemoteRepoInfoInfluencerService {
    ...
    @Autowired
    private RemoteRepoTypeInfluencerService remoteRepoTypeService ;

    public RemoteRepoInfoInfluencerServiceImpl(RemoteRepoInfoDao dao) {
        this.dao = dao;
    }
