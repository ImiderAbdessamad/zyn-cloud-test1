...
import java.util.List;
@Service
public class PackagingAgentServiceImpl implements PackagingAgentService {
    ...
    @Autowired
    private PackagingDetailAgentService packagingDetailService ;

    public PackagingAgentServiceImpl(PackagingDao dao) {
        this.dao = dao;
    }
