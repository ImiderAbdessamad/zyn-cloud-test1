package ma.zs.zyn.service.impl.open.blog;
...
import ma.zs.zyn.service.facade.open.blog.BlogOpenService;
...
import ma.zs.zyn.service.facade.open.blog.BlogSubjectOpenService ;
import ma.zs.zyn.bean.core.blog.BlogSubject ;
import ma.zs.zyn.service.facade.open.blog.BlogCommentOpenService ;
import ma.zs.zyn.bean.core.blog.BlogComment ;
import ma.zs.zyn.service.facade.open.blog.BlogStateOpenService ;
import ma.zs.zyn.bean.core.blog.BlogState ;

import java.util.List;
@Service
public class BlogOpenServiceImpl implements BlogOpenService {
    ...
    @Autowired
    private BlogSubjectOpenService blogSubjectService ;
    @Autowired
    private BlogCommentOpenService blogCommentService ;
    @Autowired
    private BlogStateOpenService blogStateService ;

    public BlogOpenServiceImpl(BlogDao dao) {
        this.dao = dao;
    }
