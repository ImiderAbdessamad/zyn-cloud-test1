...
import java.util.List;
@Service
public class BlogCommentAgentServiceImpl implements BlogCommentAgentService {
    ...
    @Autowired
    private BlogAgentService blogService ;

    public BlogCommentAgentServiceImpl(BlogCommentDao dao) {
        this.dao = dao;
    }
