package ma.zs.zyn.service.impl.agent.forum;
...
import ma.zs.zyn.service.facade.agent.forum.ForumAgentService;
...
import ma.zs.zyn.service.facade.agent.forum.ForumSubjectAgentService ;
import ma.zs.zyn.bean.core.forum.ForumSubject ;
import ma.zs.zyn.service.facade.agent.forum.ForumStateAgentService ;
import ma.zs.zyn.bean.core.forum.ForumState ;
import ma.zs.zyn.service.facade.agent.forum.ForumCommentAgentService ;
import ma.zs.zyn.bean.core.forum.ForumComment ;

import java.util.List;
@Service
public class ForumAgentServiceImpl implements ForumAgentService {
    ...
    @Autowired
    private ForumSubjectAgentService forumSubjectService ;
    @Autowired
    private ForumStateAgentService forumStateService ;
    @Autowired
    private ForumCommentAgentService forumCommentService ;

    public ForumAgentServiceImpl(ForumDao dao) {
        this.dao = dao;
    }
