...
import java.util.List;
@Service
public class ProjectTechnologyInfluencerServiceImpl implements ProjectTechnologyInfluencerService {
    ...
    @Autowired
    private ProjectTechnologyTypeInfluencerService projectTechnologyTypeService ;

    public ProjectTechnologyInfluencerServiceImpl(ProjectTechnologyDao dao) {
        this.dao = dao;
    }
