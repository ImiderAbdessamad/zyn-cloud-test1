...
import java.util.List;
@Service
public class CustumorSupportConversationMessageOpenServiceImpl implements CustumorSupportConversationMessageOpenService {
    ...
    @Autowired
    private CustumorSupportConversationOpenService custumorSupportConversationService ;

    public CustumorSupportConversationMessageOpenServiceImpl(CustumorSupportConversationMessageDao dao) {
        this.dao = dao;
    }
