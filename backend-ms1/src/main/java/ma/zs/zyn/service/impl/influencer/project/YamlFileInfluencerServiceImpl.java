...
import ma.zs.zyn.service.facade.influencer.project.YamlFileInfluencerService;
...
import java.util.List;
@Service
public class YamlFileInfluencerServiceImpl implements YamlFileInfluencerService {
    ...
    public YamlFileInfluencerServiceImpl(YamlFileDao dao) {
        this.dao = dao;
    }
