package ma.zs.zyn.service.impl.agent.packaging;
...
import ma.zs.zyn.service.facade.agent.packaging.PackagingDetailAgentService;
...
import ma.zs.zyn.service.facade.agent.packaging.PackagingDetailGroupAgentService ;
...
import java.util.List;
@Service
public class PackagingDetailAgentServiceImpl implements PackagingDetailAgentService {
    ...
    @Autowired
    private PackagingDetailGroupAgentService packagingDetailGroupService ;
    @Autowired
    private PackagingAgentService packagingService ;

    public PackagingDetailAgentServiceImpl(PackagingDetailDao dao) {
        this.dao = dao;
    }
