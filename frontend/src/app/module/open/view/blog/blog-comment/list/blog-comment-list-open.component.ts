...
@Component({
  selector: 'app-blog-comment-list-open',
  templateUrl: './blog-comment-list-open.component.html'
})
export class BlogCommentListOpenComponent implements OnInit {
    ...
    constructor( private service: BlogCommentOpenService  , private collaboratorService: CollaboratorOpenService, private blogService: BlogOpenService, @Inject(PLATFORM_ID) private platformId?) {
