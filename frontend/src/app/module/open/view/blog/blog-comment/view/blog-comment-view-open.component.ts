...
@Component({
  selector: 'app-blog-comment-view-open',
  templateUrl: './blog-comment-view-open.component.html'
})
export class BlogCommentViewOpenComponent implements OnInit {
    ...
    constructor(private service: BlogCommentOpenService, private collaboratorService: CollaboratorOpenService, private blogService: BlogOpenService){
