...
@Component({
  selector: 'app-contact-us-view-open',
  templateUrl: './contact-us-view-open.component.html'
})
export class ContactUsViewOpenComponent implements OnInit {
    ...
    constructor(private service: ContactUsOpenService, private contactUsCategoryService: ContactUsCategoryOpenService, private contactUsStateService: ContactUsStateOpenService){
