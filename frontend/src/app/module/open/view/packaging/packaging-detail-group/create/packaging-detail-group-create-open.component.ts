...
@Component({
  selector: 'app-packaging-detail-group-create-open',
  templateUrl: './packaging-detail-group-create-open.component.html'
})
export class PackagingDetailGroupCreateOpenComponent  implements OnInit {
