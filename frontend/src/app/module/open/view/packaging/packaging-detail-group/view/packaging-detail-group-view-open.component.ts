...
@Component({
  selector: 'app-packaging-detail-group-view-open',
  templateUrl: './packaging-detail-group-view-open.component.html'
})
export class PackagingDetailGroupViewOpenComponent implements OnInit {
    ...
    constructor(private service: PackagingDetailGroupOpenService){
