...
@Component({
  selector: 'app-packaging-detail-edit-open',
  templateUrl: './packaging-detail-edit-open.component.html'
})
export class PackagingDetailEditOpenComponent implements OnInit {
