...
@Component({
  selector: 'app-packaging-detail-create-open',
  templateUrl: './packaging-detail-create-open.component.html'
})
export class PackagingDetailCreateOpenComponent  implements OnInit {
