...
@Component({
  selector: 'app-packaging-create-open',
  templateUrl: './packaging-create-open.component.html'
})
export class PackagingCreateOpenComponent  implements OnInit {
   ...
   private _validPackagingCode = true;
	...
	constructor(private service: PackagingOpenService , private packagingDetailGroupService: PackagingDetailGroupOpenService, private packagingPlanService: PackagingPlanOpenService, private packagingDetailService: PackagingDetailOpenService, @Inject(PLATFORM_ID) private platformId? ) {
