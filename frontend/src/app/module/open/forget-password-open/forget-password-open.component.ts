...
@Component({
    selector: 'app-forget-password-open',
    templateUrl: './forget-password-open.component.html',
    styleUrls: ['./forget-password-open.component.css'],
})
export class ForgetPasswordOpenComponent {
