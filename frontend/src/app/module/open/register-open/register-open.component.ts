...
@Component({
  selector: 'app-register-open',
  templateUrl: './register-open.component.html',
  styleUrls: ['./register-open.component.css']
})
export class RegisterOpenComponent implements OnInit {
