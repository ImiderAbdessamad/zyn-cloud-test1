...
@Component({
  selector: 'app-change-password-open',
  templateUrl: './change-password-open.component.html',
  styleUrls: ['./change-password-open.component.css']
})
export class ChangePasswordOpenComponent implements OnInit {
    ...
    forgetPassword() {
        this.router.navigate(['/open/forget-password'])
    }
