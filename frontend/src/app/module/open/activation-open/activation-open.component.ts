...
@Component({
  selector: 'app-activation-open',
  templateUrl: './activation-open.component.html',
  styleUrls: ['./activation-open.component.css']
})
export class ActivationOpenComponent implements OnInit {
    ...
    register() {
        this.router.navigate(['/open/register']);
    }

    forget() {
        this.router.navigate(['/open/changePassword']);
    }
