...
@Component({
  selector: 'app-activation-collaborator',
  templateUrl: './activation-collaborator.component.html',
  styleUrls: ['./activation-collaborator.component.css']
})
export class ActivationCollaboratorComponent implements OnInit {
