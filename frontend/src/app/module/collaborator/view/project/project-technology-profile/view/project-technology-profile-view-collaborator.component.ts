...
@Component({
  selector: 'app-project-technology-profile-view-collaborator',
  templateUrl: './project-technology-profile-view-collaborator.component.html'
})
export class ProjectTechnologyProfileViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: ProjectTechnologyProfileCollaboratorService){
