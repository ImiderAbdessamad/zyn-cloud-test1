...
@Component({
  selector: 'app-project-technology-profile-edit-collaborator',
  templateUrl: './project-technology-profile-edit-collaborator.component.html'
})
export class ProjectTechnologyProfileEditCollaboratorComponent implements OnInit {
