...
@Component({
  selector: 'app-remote-repo-info-list-collaborator',
  templateUrl: './remote-repo-info-list-collaborator.component.html'
})
export class RemoteRepoInfoListCollaboratorComponent implements OnInit {

    protected fileName = 'RemoteRepoInfo';
    ...
    remoteRepoTypes: Array<RemoteRepoTypeDto>;
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<RemoteRepoInfoDto>();
    ...
    public async edit(dto: RemoteRepoInfoDto) {
    ...
    public async view(dto: RemoteRepoInfoDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: RemoteRepoInfoDto) {
    ...
    public async duplicate(dto: RemoteRepoInfoDto) {
    ...
    public exportPdf(dto: RemoteRepoInfoDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'remoteRepoType?.libelle', header: 'Remote repo type'},
            {field: 'collaborator?.id', header: 'Collaborator'},
        ];
    }


    public async loadRemoteRepoType(){
        this.remoteRepoTypeService.findAllOptimized().subscribe(remoteRepoTypes => this.remoteRepoTypes = remoteRepoTypes, error => console.log(error))
    }
	...
	public initDuplicate(res: RemoteRepoInfoDto) {
	}
   ...
   public prepareColumnExport(): void {
        this.exportData = this.items.map(e => {
            return {
                 ...
                 'Token': e.token ,
                 'Name': e.name ,
                'Remote repo type': e.remoteRepoType?.libelle ,
        ...
        //'Remote repo type': this.criteria.remoteRepoType?.libelle ? this.criteria.remoteRepoType?.libelle : environment.emptyForExport ,
    ...
    get selections(): Array<RemoteRepoInfoDto> {
        return this.service.selections;
    }

    set selections(value: Array<RemoteRepoInfoDto>) {
