...
@Component({
  selector: 'app-remote-repo-info-edit-collaborator',
  templateUrl: './remote-repo-info-edit-collaborator.component.html'
})
export class RemoteRepoInfoEditCollaboratorComponent implements OnInit {
