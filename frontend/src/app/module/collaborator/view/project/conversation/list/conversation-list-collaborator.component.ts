...
@Component({
  selector: 'app-conversation-list-collaborator',
  templateUrl: './conversation-list-collaborator.component.html'
})
export class ConversationListCollaboratorComponent implements OnInit {
...
// add
   ...
   public prepareColumnExport(): void {
        ...
        this.criteriaData = [{
            'Prompt': this.criteria.prompt ? this.criteria.prompt : environment.emptyForExport ,
