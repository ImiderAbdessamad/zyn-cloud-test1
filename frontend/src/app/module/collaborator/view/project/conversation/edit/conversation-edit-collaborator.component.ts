...
@Component({
  selector: 'app-conversation-edit-collaborator',
  templateUrl: './conversation-edit-collaborator.component.html'
})
export class ConversationEditCollaboratorComponent implements OnInit {
