...
@Component({
  selector: 'app-remote-repo-type-list-collaborator',
  templateUrl: './remote-repo-type-list-collaborator.component.html'
})
export class RemoteRepoTypeListCollaboratorComponent implements OnInit {
