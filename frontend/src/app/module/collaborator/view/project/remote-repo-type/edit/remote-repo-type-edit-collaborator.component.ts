...
@Component({
  selector: 'app-remote-repo-type-edit-collaborator',
  templateUrl: './remote-repo-type-edit-collaborator.component.html'
})
export class RemoteRepoTypeEditCollaboratorComponent implements OnInit {
