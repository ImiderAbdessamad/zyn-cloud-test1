...
@Component({
  selector: 'app-remote-repo-type-view-collaborator',
  templateUrl: './remote-repo-type-view-collaborator.component.html'
})
export class RemoteRepoTypeViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: RemoteRepoTypeCollaboratorService){
