...
@Component({
  selector: 'app-project-technology-type-view-collaborator',
  templateUrl: './project-technology-type-view-collaborator.component.html'
})
export class ProjectTechnologyTypeViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: ProjectTechnologyTypeCollaboratorService){
