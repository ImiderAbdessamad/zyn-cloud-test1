...
@Component({
  selector: 'app-project-technology-type-edit-collaborator',
  templateUrl: './project-technology-type-edit-collaborator.component.html'
})
export class ProjectTechnologyTypeEditCollaboratorComponent implements OnInit {
