...
@Component({
  selector: 'app-project-technology-type-list-collaborator',
  templateUrl: './project-technology-type-list-collaborator.component.html'
})
export class ProjectTechnologyTypeListCollaboratorComponent implements OnInit {
