...
@Component({
  selector: 'app-project-detail-create-collaborator',
  templateUrl: './project-detail-create-collaborator.component.html'
})
export class ProjectDetailCreateCollaboratorComponent  implements OnInit {
