...
@Component({
  selector: 'app-project-technology-view-collaborator',
  templateUrl: './project-technology-view-collaborator.component.html'
})
export class ProjectTechnologyViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: ProjectTechnologyCollaboratorService, private projectTechnologyTypeService: ProjectTechnologyTypeCollaboratorService){
