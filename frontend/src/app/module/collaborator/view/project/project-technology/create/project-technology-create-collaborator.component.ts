...
@Component({
  selector: 'app-project-technology-create-collaborator',
  templateUrl: './project-technology-create-collaborator.component.html'
})
export class ProjectTechnologyCreateCollaboratorComponent  implements OnInit {
