...
@Component({
  selector: 'app-yaml-file-list-collaborator',
  templateUrl: './yaml-file-list-collaborator.component.html'
})
export class YamlFileListCollaboratorComponent implements OnInit {
