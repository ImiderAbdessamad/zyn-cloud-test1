...
@Component({
  selector: 'app-yaml-file-view-collaborator',
  templateUrl: './yaml-file-view-collaborator.component.html'
})
export class YamlFileViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: YamlFileCollaboratorService, private projectService: ProjectCollaboratorService){
