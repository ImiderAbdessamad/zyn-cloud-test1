...
@Component({
  selector: 'app-paiment-collaborator-type-view-collaborator',
  templateUrl: './paiment-collaborator-type-view-collaborator.component.html'
})
export class PaimentCollaboratorTypeViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: PaimentCollaboratorTypeCollaboratorService){
