...
@Component({
  selector: 'app-paiment-collaborator-type-list-collaborator',
  templateUrl: './paiment-collaborator-type-list-collaborator.component.html'
})
export class PaimentCollaboratorTypeListCollaboratorComponent implements OnInit {

    protected fileName = 'PaimentCollaboratorType';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<PaimentCollaboratorTypeDto>();
    ...
    public async edit(dto: PaimentCollaboratorTypeDto) {
    ...
    public async view(dto: PaimentCollaboratorTypeDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: PaimentCollaboratorTypeDto) {
    ...
    public async duplicate(dto: PaimentCollaboratorTypeDto) {
    ...
    public exportPdf(dto: PaimentCollaboratorTypeDto): void {
...
// add
	...
	public initDuplicate(res: PaimentCollaboratorTypeDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<PaimentCollaboratorTypeDto> {
        return this.service.selections;
    }

    set selections(value: Array<PaimentCollaboratorTypeDto>) {
