...
@Component({
  selector: 'app-offre-cloud-provider-edit-collaborator',
  templateUrl: './offre-cloud-provider-edit-collaborator.component.html'
})
export class OffreCloudProviderEditCollaboratorComponent implements OnInit {
