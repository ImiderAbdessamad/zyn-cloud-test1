...
@Component({
  selector: 'app-offre-cloud-provider-list-collaborator',
  templateUrl: './offre-cloud-provider-list-collaborator.component.html'
})
export class OffreCloudProviderListCollaboratorComponent implements OnInit {
