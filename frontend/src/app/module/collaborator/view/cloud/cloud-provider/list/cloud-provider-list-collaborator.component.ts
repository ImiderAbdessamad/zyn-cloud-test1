...
@Component({
  selector: 'app-cloud-provider-list-collaborator',
  templateUrl: './cloud-provider-list-collaborator.component.html'
})
export class CloudProviderListCollaboratorComponent implements OnInit {

    protected fileName = 'CloudProvider';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<CloudProviderDto>();
    ...
    public async edit(dto: CloudProviderDto) {
    ...
    public async view(dto: CloudProviderDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: CloudProviderDto) {
    ...
    public async duplicate(dto: CloudProviderDto) {
    ...
    public exportPdf(dto: CloudProviderDto): void {
...
// add
	...
	public initDuplicate(res: CloudProviderDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<CloudProviderDto> {
        return this.service.selections;
    }

    set selections(value: Array<CloudProviderDto>) {
