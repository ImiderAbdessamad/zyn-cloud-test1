...
@Component({
  selector: 'app-cloud-provider-view-collaborator',
  templateUrl: './cloud-provider-view-collaborator.component.html'
})
export class CloudProviderViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: CloudProviderCollaboratorService){
