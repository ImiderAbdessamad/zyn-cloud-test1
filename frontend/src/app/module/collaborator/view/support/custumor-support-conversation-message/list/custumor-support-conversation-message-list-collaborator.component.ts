...
@Component({
  selector: 'app-custumor-support-conversation-message-list-collaborator',
  templateUrl: './custumor-support-conversation-message-list-collaborator.component.html'
})
export class CustumorSupportConversationMessageListCollaboratorComponent implements OnInit {
