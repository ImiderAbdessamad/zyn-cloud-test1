...
@Component({
  selector: 'app-custumor-support-conversation-message-edit-collaborator',
  templateUrl: './custumor-support-conversation-message-edit-collaborator.component.html'
})
export class CustumorSupportConversationMessageEditCollaboratorComponent implements OnInit {
