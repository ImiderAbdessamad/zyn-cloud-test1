...
@Component({
  selector: 'app-custumor-support-conversation-view-collaborator',
  templateUrl: './custumor-support-conversation-view-collaborator.component.html'
})
export class CustumorSupportConversationViewCollaboratorComponent implements OnInit {
