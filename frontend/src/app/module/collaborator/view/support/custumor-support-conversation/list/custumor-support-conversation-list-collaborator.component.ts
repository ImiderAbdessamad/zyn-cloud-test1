...
@Component({
  selector: 'app-custumor-support-conversation-list-collaborator',
  templateUrl: './custumor-support-conversation-list-collaborator.component.html'
})
export class CustumorSupportConversationListCollaboratorComponent implements OnInit {
