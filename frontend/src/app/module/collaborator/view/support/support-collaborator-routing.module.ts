                    ...
                    children: [
...

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: CustumorSupportConversationListCollaboratorComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: CustumorSupportConversationMessageListCollaboratorComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },
...
export class SupportCollaboratorRoutingModule { }
