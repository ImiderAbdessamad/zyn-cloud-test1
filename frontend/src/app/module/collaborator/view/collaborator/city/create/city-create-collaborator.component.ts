...
@Component({
  selector: 'app-city-create-collaborator',
  templateUrl: './city-create-collaborator.component.html'
})
export class CityCreateCollaboratorComponent  implements OnInit {
   ...
   private _validCityLibelle = true;
	...
	constructor(private service: CityCollaboratorService , private countryService: CountryCollaboratorService, @Inject(PLATFORM_ID) private platformId? ) {
