...
@Component({
  selector: 'app-city-view-collaborator',
  templateUrl: './city-view-collaborator.component.html'
})
export class CityViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: CityCollaboratorService, private countryService: CountryCollaboratorService){
