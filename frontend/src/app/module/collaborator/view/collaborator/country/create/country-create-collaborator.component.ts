...
@Component({
  selector: 'app-country-create-collaborator',
  templateUrl: './country-create-collaborator.component.html'
})
export class CountryCreateCollaboratorComponent  implements OnInit {
   ...
   private _validCountryLibelle = true;
	...
	constructor(private service: CountryCollaboratorService , @Inject(PLATFORM_ID) private platformId? ) {
