...
@Component({
  selector: 'app-country-view-collaborator',
  templateUrl: './country-view-collaborator.component.html'
})
export class CountryViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: CountryCollaboratorService){
