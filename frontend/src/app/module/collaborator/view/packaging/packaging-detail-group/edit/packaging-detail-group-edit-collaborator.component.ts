...
@Component({
  selector: 'app-packaging-detail-group-edit-collaborator',
  templateUrl: './packaging-detail-group-edit-collaborator.component.html'
})
export class PackagingDetailGroupEditCollaboratorComponent implements OnInit {
