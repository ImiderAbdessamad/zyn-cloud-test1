...
@Component({
  selector: 'app-packaging-detail-group-create-collaborator',
  templateUrl: './packaging-detail-group-create-collaborator.component.html'
})
export class PackagingDetailGroupCreateCollaboratorComponent  implements OnInit {
