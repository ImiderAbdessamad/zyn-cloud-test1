...
@Component({
  selector: 'app-packaging-detail-list-collaborator',
  templateUrl: './packaging-detail-list-collaborator.component.html'
})
export class PackagingDetailListCollaboratorComponent implements OnInit {
