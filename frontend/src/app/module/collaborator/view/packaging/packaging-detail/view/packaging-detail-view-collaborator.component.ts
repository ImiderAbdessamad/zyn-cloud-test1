...
@Component({
  selector: 'app-packaging-detail-view-collaborator',
  templateUrl: './packaging-detail-view-collaborator.component.html'
})
export class PackagingDetailViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: PackagingDetailCollaboratorService, private packagingDetailGroupService: PackagingDetailGroupCollaboratorService, private packagingService: PackagingCollaboratorService){
