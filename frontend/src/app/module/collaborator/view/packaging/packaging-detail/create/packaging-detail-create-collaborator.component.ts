...
@Component({
  selector: 'app-packaging-detail-create-collaborator',
  templateUrl: './packaging-detail-create-collaborator.component.html'
})
export class PackagingDetailCreateCollaboratorComponent  implements OnInit {
