...
@Component({
  selector: 'app-packaging-plan-list-collaborator',
  templateUrl: './packaging-plan-list-collaborator.component.html'
})
export class PackagingPlanListCollaboratorComponent implements OnInit {
