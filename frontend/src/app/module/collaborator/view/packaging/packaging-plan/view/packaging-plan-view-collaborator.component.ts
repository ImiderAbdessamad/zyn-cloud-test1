...
@Component({
  selector: 'app-packaging-plan-view-collaborator',
  templateUrl: './packaging-plan-view-collaborator.component.html'
})
export class PackagingPlanViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: PackagingPlanCollaboratorService, private packagingService: PackagingCollaboratorService){
