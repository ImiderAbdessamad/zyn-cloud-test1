...
@Component({
  selector: 'app-blog-comment-list-collaborator',
  templateUrl: './blog-comment-list-collaborator.component.html'
})
export class BlogCommentListCollaboratorComponent implements OnInit {

    protected fileName = 'BlogComment';
    ...
    constructor( private service: BlogCommentCollaboratorService  , private collaboratorService: CollaboratorCollaboratorService, private blogService: BlogCollaboratorService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<BlogCommentDto>();
    ...
    public async edit(dto: BlogCommentDto) {
    ...
    public async view(dto: BlogCommentDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: BlogCommentDto) {
    ...
    public async duplicate(dto: BlogCommentDto) {
    ...
    public exportPdf(dto: BlogCommentDto): void {
...
// add
    ...
    public async loadBlog(){
        this.blogService.findAll().subscribe(blogs => this.blogs = blogs, error => console.log(error))
    }


	public initDuplicate(res: BlogCommentDto) {
	}
   ...
   public prepareColumnExport(): void {
        ...
        //'Blog': this.criteria.blog?.id ? this.criteria.blog?.id : environment.emptyForExport ,
        }];
      }
    ...
    get selections(): Array<BlogCommentDto> {
        return this.service.selections;
    }

    set selections(value: Array<BlogCommentDto>) {
