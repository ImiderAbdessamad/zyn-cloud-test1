...
@Component({
  selector: 'app-blog-comment-create-collaborator',
  templateUrl: './blog-comment-create-collaborator.component.html'
})
export class BlogCommentCreateCollaboratorComponent  implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.blogService.findAll().subscribe((data) => this.blogs = data);
    }
    ...
    public async openCreateBlog(blog: string) {
    const isPermistted = await this.roleService.isPermitted('Blog', 'add');
    if(isPermistted) {
    ...
    get createBlogDialog(): boolean {
        return this.blogService.createDialog;
    }
    set createBlogDialog(value: boolean) {
        this.blogService.createDialog= value;
    }
