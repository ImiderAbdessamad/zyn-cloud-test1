...
@Component({
  selector: 'app-blog-view-collaborator',
  templateUrl: './blog-view-collaborator.component.html'
})
export class BlogViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: BlogCollaboratorService, private collaboratorService: CollaboratorCollaboratorService, private blogSubjectService: BlogSubjectCollaboratorService, private blogCommentService: BlogCommentCollaboratorService, private blogStateService: BlogStateCollaboratorService){
