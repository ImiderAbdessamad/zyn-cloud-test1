...
@Component({
  selector: 'app-blog-list-collaborator',
  templateUrl: './blog-list-collaborator.component.html'
})
export class BlogListCollaboratorComponent implements OnInit {

    protected fileName = 'Blog';
    ...
    blogSubjects: Array<BlogSubjectDto>;
    blogStates: Array<BlogStateDto>;
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<BlogDto>();
    ...
    public async delete(dto: BlogDto) {
    ...
    public async duplicate(dto: BlogDto) {
    ...
    public exportPdf(dto: BlogDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'blogSubject?.libelle', header: 'Blog subject'},
            {field: 'blogState?.libelle', header: 'Blog state'},
        ];
    }
    ...
    public async loadBlogSubject(){
        this.blogSubjectService.findAllOptimized().subscribe(blogSubjects => this.blogSubjects = blogSubjects, error => console.log(error))
    }
    public async loadBlogState(){
        this.blogStateService.findAllOptimized().subscribe(blogStates => this.blogStates = blogStates, error => console.log(error))
    }


	public initDuplicate(res: BlogDto) {
        if (res.blogComments != null) {
             res.blogComments.forEach(d => { d.blog = null; d.id = null; });
        }
	}
   ...
   public prepareColumnExport(): void {
        this.exportData = this.items.map(e => {
            return {
                ...
                'Blog subject': e.blogSubject?.libelle ,
                'Blog state': e.blogState?.libelle ,
            }
        });
        ...
        //'Blog subject': this.criteria.blogSubject?.libelle ? this.criteria.blogSubject?.libelle : environment.emptyForExport ,
        //'Blog state': this.criteria.blogState?.libelle ? this.criteria.blogState?.libelle : environment.emptyForExport ,
        }];
      }
    ...
    get selections(): Array<BlogDto> {
        return this.service.selections;
    }

    set selections(value: Array<BlogDto>) {
