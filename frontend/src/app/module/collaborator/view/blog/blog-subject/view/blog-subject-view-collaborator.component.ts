...
@Component({
  selector: 'app-blog-subject-view-collaborator',
  templateUrl: './blog-subject-view-collaborator.component.html'
})
export class BlogSubjectViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: BlogSubjectCollaboratorService){
