...
@Component({
  selector: 'app-blog-subject-create-collaborator',
  templateUrl: './blog-subject-create-collaborator.component.html'
})
export class BlogSubjectCreateCollaboratorComponent  implements OnInit {
