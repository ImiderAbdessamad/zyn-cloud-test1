...
@Component({
  selector: 'app-blog-subject-list-collaborator',
  templateUrl: './blog-subject-list-collaborator.component.html'
})
export class BlogSubjectListCollaboratorComponent implements OnInit {

    protected fileName = 'BlogSubject';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<BlogSubjectDto>();
    ...
    public async edit(dto: BlogSubjectDto) {
    ...
    public async view(dto: BlogSubjectDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: BlogSubjectDto) {
    ...
    public async duplicate(dto: BlogSubjectDto) {
    ...
    public exportPdf(dto: BlogSubjectDto): void {
...
// add
	...
	public initDuplicate(res: BlogSubjectDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<BlogSubjectDto> {
        return this.service.selections;
    }

    set selections(value: Array<BlogSubjectDto>) {
