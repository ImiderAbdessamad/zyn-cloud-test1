...
@Component({
  selector: 'app-contact-us-list-collaborator',
  templateUrl: './contact-us-list-collaborator.component.html'
})
export class ContactUsListCollaboratorComponent implements OnInit {

    protected fileName = 'ContactUs';
    ...
    contactUsCategorys: Array<ContactUsCategoryDto>;
    contactUsStates: Array<ContactUsStateDto>;
    ...
    ngOnInit(): void {
        ...
        this.initExport();
        this.initCol();
        this.loadContactUsCategory();
        this.loadContactUsState();
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ContactUsDto>();
    ...
    public async edit(dto: ContactUsDto) {
    ...
    public async view(dto: ContactUsDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ContactUsDto) {
    ...
    public async duplicate(dto: ContactUsDto) {
    ...
    public exportPdf(dto: ContactUsDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'contactUsCategory?.libelle', header: 'Contact us category'},
            {field: 'contactUsState?.libelle', header: 'Contact us state'},
        ];
    }


    public async loadContactUsCategory(){
        this.contactUsCategoryService.findAllOptimized().subscribe(contactUsCategorys => this.contactUsCategorys = contactUsCategorys, error => console.log(error))
    }
    public async loadContactUsState(){
        this.contactUsStateService.findAllOptimized().subscribe(contactUsStates => this.contactUsStates = contactUsStates, error => console.log(error))
    }


	public initDuplicate(res: ContactUsDto) {
	}
   ...
   public prepareColumnExport(): void {
        this.exportData = this.items.map(e => {
            return {
                ...
                'Contact us category': e.contactUsCategory?.libelle ,
                'Contact us state': e.contactUsState?.libelle ,
            }
        });
        ...
        //'Contact us category': this.criteria.contactUsCategory?.libelle ? this.criteria.contactUsCategory?.libelle : environment.emptyForExport ,
        //'Contact us state': this.criteria.contactUsState?.libelle ? this.criteria.contactUsState?.libelle : environment.emptyForExport ,
        }];
      }
    ...
    get selections(): Array<ContactUsDto> {
        return this.service.selections;
    }

    set selections(value: Array<ContactUsDto>) {
