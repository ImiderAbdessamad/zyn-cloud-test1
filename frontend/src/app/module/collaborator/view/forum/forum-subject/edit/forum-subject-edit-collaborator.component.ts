...
@Component({
  selector: 'app-forum-subject-edit-collaborator',
  templateUrl: './forum-subject-edit-collaborator.component.html'
})
export class ForumSubjectEditCollaboratorComponent implements OnInit {
