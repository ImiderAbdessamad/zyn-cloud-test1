...
@Component({
  selector: 'app-forum-subject-view-collaborator',
  templateUrl: './forum-subject-view-collaborator.component.html'
})
export class ForumSubjectViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: ForumSubjectCollaboratorService){
