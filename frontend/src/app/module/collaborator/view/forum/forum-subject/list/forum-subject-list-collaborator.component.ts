...
@Component({
  selector: 'app-forum-subject-list-collaborator',
  templateUrl: './forum-subject-list-collaborator.component.html'
})
export class ForumSubjectListCollaboratorComponent implements OnInit {
