...
@Component({
  selector: 'app-forum-comment-list-collaborator',
  templateUrl: './forum-comment-list-collaborator.component.html'
})
export class ForumCommentListCollaboratorComponent implements OnInit {
