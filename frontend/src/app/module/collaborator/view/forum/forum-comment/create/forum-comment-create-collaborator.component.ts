...
@Component({
  selector: 'app-forum-comment-create-collaborator',
  templateUrl: './forum-comment-create-collaborator.component.html'
})
export class ForumCommentCreateCollaboratorComponent  implements OnInit {
