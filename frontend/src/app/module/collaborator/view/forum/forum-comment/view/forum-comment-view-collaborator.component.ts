...
@Component({
  selector: 'app-forum-comment-view-collaborator',
  templateUrl: './forum-comment-view-collaborator.component.html'
})
export class ForumCommentViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: ForumCommentCollaboratorService, private collaboratorService: CollaboratorCollaboratorService, private forumService: ForumCollaboratorService){
