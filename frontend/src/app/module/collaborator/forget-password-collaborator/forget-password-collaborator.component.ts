...
@Component({
    selector: 'app-forget-password-collaborator',
    templateUrl: './forget-password-collaborator.component.html',
    styleUrls: ['./forget-password-collaborator.component.css'],
})
export class ForgetPasswordCollaboratorComponent {
