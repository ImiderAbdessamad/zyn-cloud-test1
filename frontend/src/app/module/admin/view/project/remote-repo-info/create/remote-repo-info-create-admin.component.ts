...
@Component({
  selector: 'app-remote-repo-info-create-admin',
  templateUrl: './remote-repo-info-create-admin.component.html'
})
export class RemoteRepoInfoCreateAdminComponent  implements OnInit {
