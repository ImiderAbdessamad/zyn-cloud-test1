...
@Component({
  selector: 'app-remote-repo-info-list-admin',
  templateUrl: './remote-repo-info-list-admin.component.html'
})
export class RemoteRepoInfoListAdminComponent implements OnInit {
