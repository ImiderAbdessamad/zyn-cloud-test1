...
@Component({
  selector: 'app-remote-repo-info-view-admin',
  templateUrl: './remote-repo-info-view-admin.component.html'
})
export class RemoteRepoInfoViewAdminComponent implements OnInit {
    ...
    constructor(private service: RemoteRepoInfoAdminService, private collaboratorService: CollaboratorAdminService, private remoteRepoTypeService: RemoteRepoTypeAdminService){
