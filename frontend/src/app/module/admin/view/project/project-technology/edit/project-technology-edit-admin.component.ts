...
@Component({
  selector: 'app-project-technology-edit-admin',
  templateUrl: './project-technology-edit-admin.component.html'
})
export class ProjectTechnologyEditAdminComponent implements OnInit {
