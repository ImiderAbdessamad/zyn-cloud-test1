...
@Component({
  selector: 'app-remote-repo-type-view-admin',
  templateUrl: './remote-repo-type-view-admin.component.html'
})
export class RemoteRepoTypeViewAdminComponent implements OnInit {
    ...
    constructor(private service: RemoteRepoTypeAdminService){
