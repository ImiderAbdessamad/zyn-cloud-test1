...
@Component({
  selector: 'app-remote-repo-type-create-admin',
  templateUrl: './remote-repo-type-create-admin.component.html'
})
export class RemoteRepoTypeCreateAdminComponent  implements OnInit {
