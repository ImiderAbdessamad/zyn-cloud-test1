...
@Component({
  selector: 'app-remote-repo-type-edit-admin',
  templateUrl: './remote-repo-type-edit-admin.component.html'
})
export class RemoteRepoTypeEditAdminComponent implements OnInit {
