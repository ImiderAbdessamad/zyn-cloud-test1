...
export class ProjectViewAdminComponent implements OnInit {
    ...
    constructor(private service: ProjectAdminService, private collaboratorService: CollaboratorAdminService, private projectTechnologyService: ProjectTechnologyAdminService, private remoteRepoInfoService: RemoteRepoInfoAdminService, private conversationService: ConversationAdminService, private projectTechnologyProfileService: ProjectTechnologyProfileAdminService, private projectDetailService: ProjectDetailAdminService){
