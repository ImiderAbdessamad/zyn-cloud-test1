...
@Component({
  selector: 'app-project-technology-type-view-admin',
  templateUrl: './project-technology-type-view-admin.component.html'
})
export class ProjectTechnologyTypeViewAdminComponent implements OnInit {
    ...
    constructor(private service: ProjectTechnologyTypeAdminService){
