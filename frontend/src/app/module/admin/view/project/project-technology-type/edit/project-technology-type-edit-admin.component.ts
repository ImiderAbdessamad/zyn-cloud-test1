...
@Component({
  selector: 'app-project-technology-type-edit-admin',
  templateUrl: './project-technology-type-edit-admin.component.html'
})
export class ProjectTechnologyTypeEditAdminComponent implements OnInit {
