...
@Component({
  selector: 'app-project-technology-type-create-admin',
  templateUrl: './project-technology-type-create-admin.component.html'
})
export class ProjectTechnologyTypeCreateAdminComponent  implements OnInit {
