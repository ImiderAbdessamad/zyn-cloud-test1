...
@Component({
  selector: 'app-project-detail-edit-admin',
  templateUrl: './project-detail-edit-admin.component.html'
})
export class ProjectDetailEditAdminComponent implements OnInit {
