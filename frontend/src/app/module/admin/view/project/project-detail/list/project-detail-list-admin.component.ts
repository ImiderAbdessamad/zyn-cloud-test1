...
@Component({
  selector: 'app-project-detail-list-admin',
  templateUrl: './project-detail-list-admin.component.html'
})
export class ProjectDetailListAdminComponent implements OnInit {
