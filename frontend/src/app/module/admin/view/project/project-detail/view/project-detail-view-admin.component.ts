...
@Component({
  selector: 'app-project-detail-view-admin',
  templateUrl: './project-detail-view-admin.component.html'
})
export class ProjectDetailViewAdminComponent implements OnInit {
    ...
    constructor(private service: ProjectDetailAdminService, private projectService: ProjectAdminService, private projectTechnologyService: ProjectTechnologyAdminService, private projectTechnologyProfileService: ProjectTechnologyProfileAdminService){
