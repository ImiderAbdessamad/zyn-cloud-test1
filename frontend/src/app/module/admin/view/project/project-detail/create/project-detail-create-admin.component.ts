...
@Component({
  selector: 'app-project-detail-create-admin',
  templateUrl: './project-detail-create-admin.component.html'
})
export class ProjectDetailCreateAdminComponent  implements OnInit {
   ...
   private _validProjectDetailPort = true;
	...
	constructor(private service: ProjectDetailAdminService , private projectService: ProjectAdminService, private projectTechnologyService: ProjectTechnologyAdminService, private projectTechnologyProfileService: ProjectTechnologyProfileAdminService, @Inject(PLATFORM_ID) private platformId? ) {
