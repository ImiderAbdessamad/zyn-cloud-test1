...
@Component({
  selector: 'app-project-technology-profile-view-admin',
  templateUrl: './project-technology-profile-view-admin.component.html'
})
export class ProjectTechnologyProfileViewAdminComponent implements OnInit {
    ...
    constructor(private service: ProjectTechnologyProfileAdminService){
