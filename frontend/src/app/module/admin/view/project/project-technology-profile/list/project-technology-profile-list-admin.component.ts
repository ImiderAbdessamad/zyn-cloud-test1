...
@Component({
  selector: 'app-project-technology-profile-list-admin',
  templateUrl: './project-technology-profile-list-admin.component.html'
})
export class ProjectTechnologyProfileListAdminComponent implements OnInit {
