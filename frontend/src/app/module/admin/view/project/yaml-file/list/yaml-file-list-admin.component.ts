...
@Component({
  selector: 'app-yaml-file-list-admin',
  templateUrl: './yaml-file-list-admin.component.html'
})
export class YamlFileListAdminComponent implements OnInit {

    protected fileName = 'YamlFile';
    ...
    constructor( private service: YamlFileAdminService  , private projectService: ProjectAdminService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<YamlFileDto>();
    ...
    public async edit(dto: YamlFileDto) {
    ...
    public async view(dto: YamlFileDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: YamlFileDto) {
    ...
    public async duplicate(dto: YamlFileDto) {
    ...
    public exportPdf(dto: YamlFileDto): void {
...
// add
	...
	public initDuplicate(res: YamlFileDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<YamlFileDto> {
        return this.service.selections;
    }

    set selections(value: Array<YamlFileDto>) {
