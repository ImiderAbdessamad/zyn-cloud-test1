...
@Component({
  selector: 'app-custumor-support-conversation-category-view-admin',
  templateUrl: './custumor-support-conversation-category-view-admin.component.html'
})
export class CustumorSupportConversationCategoryViewAdminComponent implements OnInit {
    ...
    constructor(private service: CustumorSupportConversationCategoryAdminService){
