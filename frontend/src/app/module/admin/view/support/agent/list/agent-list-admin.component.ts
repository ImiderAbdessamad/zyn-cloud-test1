...
import {AgentCriteria} from 'src/app/shared/criteria/support/AgentCriteria.model';
...
export class AgentListAdminComponent implements OnInit {
    ...
    constructor( private service: AgentAdminService  , @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<AgentDto>();
    ...
    public async edit(dto: AgentDto) {
    ...
    public async view(dto: AgentDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: AgentDto) {
    ...
    public async duplicate(dto: AgentDto) {
    ...
    public exportPdf(dto: AgentDto): void {
...
// add
	...
	public initDuplicate(res: AgentDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<AgentDto> {
        return this.service.selections;
    }

    set selections(value: Array<AgentDto>) {
