...
@Component({
  selector: 'app-custumor-support-conversation-message-view-admin',
  templateUrl: './custumor-support-conversation-message-view-admin.component.html'
})
export class CustumorSupportConversationMessageViewAdminComponent implements OnInit {
    ...
    constructor(private service: CustumorSupportConversationMessageAdminService, private custumorSupportConversationService: CustumorSupportConversationAdminService){
