...
@Component({
  selector: 'app-custumor-support-conversation-state-list-admin',
  templateUrl: './custumor-support-conversation-state-list-admin.component.html'
})
export class CustumorSupportConversationStateListAdminComponent implements OnInit {

    protected fileName = 'CustumorSupportConversationState';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<CustumorSupportConversationStateDto>();
    ...
    public async edit(dto: CustumorSupportConversationStateDto) {
    ...
    public async view(dto: CustumorSupportConversationStateDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: CustumorSupportConversationStateDto) {
    ...
    public async duplicate(dto: CustumorSupportConversationStateDto) {
    ...
    public exportPdf(dto: CustumorSupportConversationStateDto): void {
...
// add
	...
	public initDuplicate(res: CustumorSupportConversationStateDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<CustumorSupportConversationStateDto> {
        return this.service.selections;
    }

    set selections(value: Array<CustumorSupportConversationStateDto>) {
