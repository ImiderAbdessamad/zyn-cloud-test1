...
@Component({
  selector: 'app-custumor-support-conversation-state-view-admin',
  templateUrl: './custumor-support-conversation-state-view-admin.component.html'
})
export class CustumorSupportConversationStateViewAdminComponent implements OnInit {
    ...
    constructor(private service: CustumorSupportConversationStateAdminService){
