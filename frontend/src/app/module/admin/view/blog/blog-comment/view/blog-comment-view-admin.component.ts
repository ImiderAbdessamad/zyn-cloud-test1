...
@Component({
  selector: 'app-blog-comment-view-admin',
  templateUrl: './blog-comment-view-admin.component.html'
})
export class BlogCommentViewAdminComponent implements OnInit {
    ...
    constructor(private service: BlogCommentAdminService, private collaboratorService: CollaboratorAdminService, private blogService: BlogAdminService){
