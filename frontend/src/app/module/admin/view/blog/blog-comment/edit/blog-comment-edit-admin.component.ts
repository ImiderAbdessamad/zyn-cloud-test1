...
@Component({
  selector: 'app-blog-comment-edit-admin',
  templateUrl: './blog-comment-edit-admin.component.html'
})
export class BlogCommentEditAdminComponent implements OnInit {
 ...
 public edit(): void {
   ...
   public async openCreateBlog(blog: string) {
        const isPermistted = await this.roleService.isPermitted('Blog', 'edit');
        if (isPermistted) {
