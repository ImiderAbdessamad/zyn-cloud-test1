...
@Component({
  selector: 'app-blog-comment-list-admin',
  templateUrl: './blog-comment-list-admin.component.html'
})
export class BlogCommentListAdminComponent implements OnInit {
    ...
    constructor( private service: BlogCommentAdminService  , private collaboratorService: CollaboratorAdminService, private blogService: BlogAdminService, @Inject(PLATFORM_ID) private platformId?) {
