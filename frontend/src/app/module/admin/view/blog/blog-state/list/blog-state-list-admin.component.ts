...
@Component({
  selector: 'app-blog-state-list-admin',
  templateUrl: './blog-state-list-admin.component.html'
})
export class BlogStateListAdminComponent implements OnInit {

    protected fileName = 'BlogState';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<BlogStateDto>();
    ...
    public async edit(dto: BlogStateDto) {
    ...
    public async view(dto: BlogStateDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: BlogStateDto) {
    ...
    public async duplicate(dto: BlogStateDto) {
    ...
    public exportPdf(dto: BlogStateDto): void {
...
// add
	...
	public initDuplicate(res: BlogStateDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<BlogStateDto> {
        return this.service.selections;
    }

    set selections(value: Array<BlogStateDto>) {
