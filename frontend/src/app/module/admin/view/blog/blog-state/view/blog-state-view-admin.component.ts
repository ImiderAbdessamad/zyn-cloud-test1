...
@Component({
  selector: 'app-blog-state-view-admin',
  templateUrl: './blog-state-view-admin.component.html'
})
export class BlogStateViewAdminComponent implements OnInit {
    ...
    constructor(private service: BlogStateAdminService){
