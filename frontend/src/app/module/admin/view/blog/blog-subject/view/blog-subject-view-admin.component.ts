...
@Component({
  selector: 'app-blog-subject-view-admin',
  templateUrl: './blog-subject-view-admin.component.html'
})
export class BlogSubjectViewAdminComponent implements OnInit {
    ...
    constructor(private service: BlogSubjectAdminService){
