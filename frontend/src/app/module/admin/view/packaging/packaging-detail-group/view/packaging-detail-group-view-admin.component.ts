...
@Component({
  selector: 'app-packaging-detail-group-view-admin',
  templateUrl: './packaging-detail-group-view-admin.component.html'
})
export class PackagingDetailGroupViewAdminComponent implements OnInit {
    ...
    constructor(private service: PackagingDetailGroupAdminService){
