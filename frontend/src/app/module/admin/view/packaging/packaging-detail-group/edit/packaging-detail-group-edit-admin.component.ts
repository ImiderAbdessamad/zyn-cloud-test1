...
@Component({
  selector: 'app-packaging-detail-group-edit-admin',
  templateUrl: './packaging-detail-group-edit-admin.component.html'
})
export class PackagingDetailGroupEditAdminComponent implements OnInit {
