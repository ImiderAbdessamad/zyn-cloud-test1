...
@Component({
  selector: 'app-packaging-detail-edit-admin',
  templateUrl: './packaging-detail-edit-admin.component.html'
})
export class PackagingDetailEditAdminComponent implements OnInit {
