...
@Component({
  selector: 'app-packaging-detail-view-admin',
  templateUrl: './packaging-detail-view-admin.component.html'
})
export class PackagingDetailViewAdminComponent implements OnInit {
    ...
    constructor(private service: PackagingDetailAdminService, private packagingDetailGroupService: PackagingDetailGroupAdminService, private packagingService: PackagingAdminService){
