...
@Component({
  selector: 'app-packaging-detail-list-admin',
  templateUrl: './packaging-detail-list-admin.component.html'
})
export class PackagingDetailListAdminComponent implements OnInit {
