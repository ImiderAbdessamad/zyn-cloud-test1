...
@Component({
  selector: 'app-packaging-plan-list-admin',
  templateUrl: './packaging-plan-list-admin.component.html'
})
export class PackagingPlanListAdminComponent implements OnInit {

    protected fileName = 'PackagingPlan';
    ...
    constructor( private service: PackagingPlanAdminService  , private packagingService: PackagingAdminService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<PackagingPlanDto>();
    ...
    public async edit(dto: PackagingPlanDto) {
    ...
    public async view(dto: PackagingPlanDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: PackagingPlanDto) {
    ...
    public async duplicate(dto: PackagingPlanDto) {
    ...
    public exportPdf(dto: PackagingPlanDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'numberOfMonth', header: 'Number of month'},
	...
	public initDuplicate(res: PackagingPlanDto) {
	}
   ...
   public prepareColumnExport(): void {
        this.exportData = this.items.map(e => {
            return {
                ...
                'Packaging': e.packaging?.code ,
                 'Number of month': e.numberOfMonth ,
                 'Price': e.price ,
        ...
        //'Packaging': this.criteria.packaging?.code ? this.criteria.packaging?.code : environment.emptyForExport ,
            'Number of month Min': this.criteria.numberOfMonthMin ? this.criteria.numberOfMonthMin : environment.emptyForExport ,
            'Number of month Max': this.criteria.numberOfMonthMax ? this.criteria.numberOfMonthMax : environment.emptyForExport ,
    ...
    get selections(): Array<PackagingPlanDto> {
        return this.service.selections;
    }

    set selections(value: Array<PackagingPlanDto>) {
