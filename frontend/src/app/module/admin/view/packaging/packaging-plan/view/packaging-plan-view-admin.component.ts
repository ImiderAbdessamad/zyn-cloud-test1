...
@Component({
  selector: 'app-packaging-plan-view-admin',
  templateUrl: './packaging-plan-view-admin.component.html'
})
export class PackagingPlanViewAdminComponent implements OnInit {
    ...
    constructor(private service: PackagingPlanAdminService, private packagingService: PackagingAdminService){
