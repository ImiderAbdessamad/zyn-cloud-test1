...
@Component({
  selector: 'app-contact-us-state-list-admin',
  templateUrl: './contact-us-state-list-admin.component.html'
})
export class ContactUsStateListAdminComponent implements OnInit {

    protected fileName = 'ContactUsState';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ContactUsStateDto>();
    ...
    public async edit(dto: ContactUsStateDto) {
    ...
    public async view(dto: ContactUsStateDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ContactUsStateDto) {
    ...
    public async duplicate(dto: ContactUsStateDto) {
    ...
    public exportPdf(dto: ContactUsStateDto): void {
...
// add
	...
	public initDuplicate(res: ContactUsStateDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<ContactUsStateDto> {
        return this.service.selections;
    }

    set selections(value: Array<ContactUsStateDto>) {
