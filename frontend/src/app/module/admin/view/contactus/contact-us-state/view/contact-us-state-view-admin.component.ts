...
@Component({
  selector: 'app-contact-us-state-view-admin',
  templateUrl: './contact-us-state-view-admin.component.html'
})
export class ContactUsStateViewAdminComponent implements OnInit {
    ...
    constructor(private service: ContactUsStateAdminService){
