...
@Component({
  selector: 'app-contact-us-category-view-admin',
  templateUrl: './contact-us-category-view-admin.component.html'
})
export class ContactUsCategoryViewAdminComponent implements OnInit {
    ...
    constructor(private service: ContactUsCategoryAdminService){
