...
@Component({
  selector: 'app-contact-us-category-list-admin',
  templateUrl: './contact-us-category-list-admin.component.html'
})
export class ContactUsCategoryListAdminComponent implements OnInit {

    protected fileName = 'ContactUsCategory';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ContactUsCategoryDto>();
    ...
    public async edit(dto: ContactUsCategoryDto) {
    ...
    public async view(dto: ContactUsCategoryDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ContactUsCategoryDto) {
    ...
    public async duplicate(dto: ContactUsCategoryDto) {
    ...
    public exportPdf(dto: ContactUsCategoryDto): void {
...
// add
	...
	public initDuplicate(res: ContactUsCategoryDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<ContactUsCategoryDto> {
        return this.service.selections;
    }

    set selections(value: Array<ContactUsCategoryDto>) {
