...
@Component({
  selector: 'app-contact-us-view-admin',
  templateUrl: './contact-us-view-admin.component.html'
})
export class ContactUsViewAdminComponent implements OnInit {
    ...
    constructor(private service: ContactUsAdminService, private contactUsCategoryService: ContactUsCategoryAdminService, private contactUsStateService: ContactUsStateAdminService){
