...
@Component({
  selector: 'app-forum-view-admin',
  templateUrl: './forum-view-admin.component.html'
})
export class ForumViewAdminComponent implements OnInit {
    ...
    constructor(private service: ForumAdminService, private collaboratorService: CollaboratorAdminService, private forumSubjectService: ForumSubjectAdminService, private forumStateService: ForumStateAdminService, private forumCommentService: ForumCommentAdminService){
