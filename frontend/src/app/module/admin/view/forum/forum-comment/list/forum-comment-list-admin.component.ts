...
@Component({
  selector: 'app-forum-comment-list-admin',
  templateUrl: './forum-comment-list-admin.component.html'
})
export class ForumCommentListAdminComponent implements OnInit {

    protected fileName = 'ForumComment';
    ...
    forums: Array<ForumDto>;


    constructor( private service: ForumCommentAdminService  , private collaboratorService: CollaboratorAdminService, private forumService: ForumAdminService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ForumCommentDto>();
    ...
    public async edit(dto: ForumCommentDto) {
    ...
    public async view(dto: ForumCommentDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ForumCommentDto) {
    ...
    public async duplicate(dto: ForumCommentDto) {
    ...
    public exportPdf(dto: ForumCommentDto): void {
...
// add
    ...
    public async loadForum(){
        this.forumService.findAll().subscribe(forums => this.forums = forums, error => console.log(error))
    }


	public initDuplicate(res: ForumCommentDto) {
	}
   ...
   public prepareColumnExport(): void {
        ...
        //'Forum': this.criteria.forum?.id ? this.criteria.forum?.id : environment.emptyForExport ,
        }];
      }
    ...
    get selections(): Array<ForumCommentDto> {
        return this.service.selections;
    }

    set selections(value: Array<ForumCommentDto>) {
