...
@Component({
  selector: 'app-forum-comment-view-admin',
  templateUrl: './forum-comment-view-admin.component.html'
})
export class ForumCommentViewAdminComponent implements OnInit {
    ...
    constructor(private service: ForumCommentAdminService, private collaboratorService: CollaboratorAdminService, private forumService: ForumAdminService){
