...
@Component({
  selector: 'app-forum-subject-view-admin',
  templateUrl: './forum-subject-view-admin.component.html'
})
export class ForumSubjectViewAdminComponent implements OnInit {
    ...
    constructor(private service: ForumSubjectAdminService){
