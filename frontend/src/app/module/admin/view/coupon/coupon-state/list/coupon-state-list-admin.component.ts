...
@Component({
  selector: 'app-coupon-state-list-admin',
  templateUrl: './coupon-state-list-admin.component.html'
})
export class CouponStateListAdminComponent implements OnInit {

    protected fileName = 'CouponState';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<CouponStateDto>();
    ...
    public async edit(dto: CouponStateDto) {
    ...
    public async view(dto: CouponStateDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: CouponStateDto) {
    ...
    public async duplicate(dto: CouponStateDto) {
    ...
    public exportPdf(dto: CouponStateDto): void {
...
// add
	...
	public initDuplicate(res: CouponStateDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<CouponStateDto> {
        return this.service.selections;
    }

    set selections(value: Array<CouponStateDto>) {
