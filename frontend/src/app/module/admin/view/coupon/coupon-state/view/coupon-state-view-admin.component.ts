...
@Component({
  selector: 'app-coupon-state-view-admin',
  templateUrl: './coupon-state-view-admin.component.html'
})
export class CouponStateViewAdminComponent implements OnInit {
    ...
    constructor(private service: CouponStateAdminService){
