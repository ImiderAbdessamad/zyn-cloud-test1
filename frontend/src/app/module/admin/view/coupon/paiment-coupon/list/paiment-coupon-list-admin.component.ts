...
@Component({
  selector: 'app-paiment-coupon-list-admin',
  templateUrl: './paiment-coupon-list-admin.component.html'
})
export class PaimentCouponListAdminComponent implements OnInit {
