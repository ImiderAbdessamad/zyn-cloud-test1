...
@Component({
  selector: 'app-paiment-coupon-view-admin',
  templateUrl: './paiment-coupon-view-admin.component.html'
})
export class PaimentCouponViewAdminComponent implements OnInit {
    ...
    constructor(private service: PaimentCouponAdminService, private couponService: CouponAdminService, private paimentCouponStateService: PaimentCouponStateAdminService){
