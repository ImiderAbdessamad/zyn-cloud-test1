...
@Component({
  selector: 'app-cloud-provider-edit-admin',
  templateUrl: './cloud-provider-edit-admin.component.html'
})
export class CloudProviderEditAdminComponent implements OnInit {
