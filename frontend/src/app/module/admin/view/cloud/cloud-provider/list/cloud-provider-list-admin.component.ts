...
@Component({
  selector: 'app-cloud-provider-list-admin',
  templateUrl: './cloud-provider-list-admin.component.html'
})
export class CloudProviderListAdminComponent implements OnInit {
