...
@Component({
  selector: 'app-cloud-provider-view-admin',
  templateUrl: './cloud-provider-view-admin.component.html'
})
export class CloudProviderViewAdminComponent implements OnInit {
    ...
    constructor(private service: CloudProviderAdminService){
