...
@Component({
  selector: 'app-offre-cloud-provider-create-admin',
  templateUrl: './offre-cloud-provider-create-admin.component.html'
})
export class OffreCloudProviderCreateAdminComponent  implements OnInit {
