...
@Component({
  selector: 'app-offre-cloud-provider-view-admin',
  templateUrl: './offre-cloud-provider-view-admin.component.html'
})
export class OffreCloudProviderViewAdminComponent implements OnInit {
    ...
    constructor(private service: OffreCloudProviderAdminService, private cloudProviderService: CloudProviderAdminService){
