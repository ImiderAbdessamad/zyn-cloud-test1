...
@Component({
  selector: 'app-offre-cloud-provider-edit-admin',
  templateUrl: './offre-cloud-provider-edit-admin.component.html'
})
export class OffreCloudProviderEditAdminComponent implements OnInit {
 ...
 public edit(): void {
   ...
   public async openCreateCloudProvider(cloudProvider: string) {
        const isPermistted = await this.roleService.isPermitted('CloudProvider', 'edit');
        if (isPermistted) {
