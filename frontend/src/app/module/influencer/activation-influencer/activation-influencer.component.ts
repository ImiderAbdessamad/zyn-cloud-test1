...
@Component({
  selector: 'app-activation-influencer',
  templateUrl: './activation-influencer.component.html',
  styleUrls: ['./activation-influencer.component.css']
})
export class ActivationInfluencerComponent implements OnInit {
    ...
    forget() {
        this.router.navigate(['/influencer/changePassword']);
    }
