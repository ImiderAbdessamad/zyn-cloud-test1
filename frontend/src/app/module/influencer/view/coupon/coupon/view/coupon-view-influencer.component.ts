...
export class CouponViewInfluencerComponent implements OnInit {
    ...
    constructor(private service: CouponInfluencerService, private influencerService: InfluencerInfluencerService, private couponStateService: CouponStateInfluencerService){
