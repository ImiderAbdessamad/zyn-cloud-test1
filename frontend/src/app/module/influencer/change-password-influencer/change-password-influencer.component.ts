...
@Component({
  selector: 'app-change-password-influencer',
  templateUrl: './change-password-influencer.component.html',
  styleUrls: ['./change-password-influencer.component.css']
})
export class ChangePasswordInfluencerComponent implements OnInit {
    ...
    forgetPassword() {
        this.router.navigate(['/influencer/forget-password'])
    }
