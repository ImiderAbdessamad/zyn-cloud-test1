...
@Component({
  selector: 'app-activation-agent',
  templateUrl: './activation-agent.component.html',
  styleUrls: ['./activation-agent.component.css']
})
export class ActivationAgentComponent implements OnInit {
