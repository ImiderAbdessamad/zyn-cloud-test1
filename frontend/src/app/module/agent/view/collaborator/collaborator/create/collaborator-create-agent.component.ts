...
import {CountryAgentService} from 'src/app/shared/service/agent/collaborator/CountryAgent.service';
import {CityDto} from 'src/app/shared/model/collaborator/City.model';
import {CityAgentService} from 'src/app/shared/service/agent/collaborator/CityAgent.service';
@Component({
  selector: 'app-collaborator-create-agent',
  templateUrl: './collaborator-create-agent.component.html'
})
export class CollaboratorCreateAgentComponent  implements OnInit {
	...
	constructor(private service: CollaboratorAgentService , private countryService: CountryAgentService, private cityService: CityAgentService, @Inject(PLATFORM_ID) private platformId? ) {
