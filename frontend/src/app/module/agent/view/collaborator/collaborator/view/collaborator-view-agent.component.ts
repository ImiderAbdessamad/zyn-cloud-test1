...
@Component({
  selector: 'app-collaborator-view-agent',
  templateUrl: './collaborator-view-agent.component.html'
})
export class CollaboratorViewAgentComponent implements OnInit {
    ...
    constructor(private service: CollaboratorAgentService, private countryService: CountryAgentService, private cityService: CityAgentService){
