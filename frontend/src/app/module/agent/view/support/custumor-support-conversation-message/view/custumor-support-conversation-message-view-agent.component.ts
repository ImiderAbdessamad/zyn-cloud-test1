...
@Component({
  selector: 'app-custumor-support-conversation-message-view-agent',
  templateUrl: './custumor-support-conversation-message-view-agent.component.html'
})
export class CustumorSupportConversationMessageViewAgentComponent implements OnInit {
    ...
    constructor(private service: CustumorSupportConversationMessageAgentService, private custumorSupportConversationService: CustumorSupportConversationAgentService){
