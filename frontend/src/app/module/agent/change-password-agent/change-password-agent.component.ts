...
@Component({
  selector: 'app-change-password-agent',
  templateUrl: './change-password-agent.component.html',
  styleUrls: ['./change-password-agent.component.css']
})
export class ChangePasswordAgentComponent implements OnInit {
    ...
    forgetPassword() {
        this.router.navigate(['/agent/forget-password'])
    }
