import {PackagingPlanCriteria} from './PackagingPlanCriteria.model';
import {PackagingDetailCriteria} from './PackagingDetailCriteria.model';
...
export class PackagingCriteria extends BaseCriteria {
    ...
    public descriptionLike: string;
     ...
     public maxTokenOutputMax: number;
      ...
      public packagingDetails: Array<PackagingDetailCriteria>;
